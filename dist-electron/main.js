...
var N = (t, e, r) => w$(t, typeof e != "symbol" ? e + "" : e, r), fl = (t, e, r) => e.has(t) || dl("Cannot " + r);
var ve = (t, e, r) => (fl(t, e, "read from private field"), r ? r.call(t) : e.get(t)), En = (t, e, r) => e.has(t) ? dl("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), Nn = (t, e, r, n) => (fl(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r);
import Pn, { randomUUID as Go } from "node:crypto";
import Z from "node:fs";
import X from "node:path";
import { fileURLToPath as b$ } from "node:url";
import em, { app as Lt, protocol as tm, ipcMain as fe, screen as an, BrowserWindow as xo, Menu as hl, dialog as rm } from "electron";
import _e from "node:process";
import { promisify as ke, isDeepStrictEqual as S$ } from "node:util";
import E$ from "node:assert";
import Dr from "node:os";
import "node:events";
import "node:stream";
import jn from "better-sqlite3";
import Ho from "node:http";
import N$ from "node:dgram";
const Tr = (t) => {
  const e = typeof t;
...
function T$(t, e, r) {
  ...
  for (let s = 0; s < n.length; s++) {
    const a = n[s];
    if (Jo(t, a) ? t = s === n.length - 1 ? void 0 : null : t = t[a], t == null) {
      if (s !== n.length - 1)
        return r;
      break;
    }
...
function ml(t, e, r) {
  ...
  for (let a = 0; a < s.length; a++) {
    const o = s[a];
    nm(t, o), a === s.length - 1 ? t[o] = r : Tr(t[o]) || (t[o] = typeof s[a + 1] == "number" ? [] : {}), t = t[o];
  }
  return n;
}
function O$(t, e) {
...
function R$(t, e) {
  ...
  if (r.length === 0)
    return !1;
  for (const n of r) {
    if (!Tr(t) || !(n in t) || Jo(t, n))
      return !1;
    t = t[n];
  }
  return !0;
}
const xt = Dr.homedir(), Wo = Dr.tmpdir(), { env: Jr } = _e, I$ = (t) => {
...
function A$(t, { suffix: e = "nodejs" } = {}) {
  if (typeof t != "string")
    throw new TypeError(`Expected a string, got ${typeof t}`);
  return e && (t += `-${e}`), _e.platform === "darwin" ? I$(t) : _e.platform === "win32" ? j$(t) : C$(t);
}
const Vt = (t, e) => {
  const { onError: r } = e;
  return function(...s) {
  ...
  return function(s) {
    const { timeout: a } = s, o = s.interval ?? k$, i = Date.now() + a;
    return function c(...d) {
...
}, D$ = "utf8", pl = 438, M$ = 511, V$ = {}, F$ = _e.geteuid ? _e.geteuid() : -1, q$ = _e.getegid ? _e.getegid() : -1, z$ = 1e3, U$ = !!_e.getuid;
_e.getuid && _e.getuid();
const yl = 128, B$ = (t) => t instanceof Error && "code" in t, $l = (t) => typeof t == "string", Va = (t) => t === void 0, K$ = _e.platform === "linux", sm = _e.platform === "win32", Xo = ["SIGHUP", "SIGINT", "SIGTERM"];
sm || Xo.push("SIGALRM", "SIGABRT", "SIGVTALRM", "SIGXCPU", "SIGXFSZ", "SIGUSR2", "SIGTRAP", "SIGSYS", "SIGQUIT", "SIGIOT");
K$ && Xo.push("SIGIO", "SIGPOLL", "SIGPWR", "SIGSTKFLT");
class Q$ {
  /* CONSTRUCTOR */
  constructor() {
    this.callbacks = /* @__PURE__ */ new Set(), this.exited = !1, this.exit = (e) => {
      if (!this.exited) {
        ...
        for (const r of this.callbacks)
          r();
        e && (sm && e !== "SIGINT" && e !== "SIGTERM" && e !== "SIGKILL" ? _e.kill(_e.pid, "SIGTERM") : _e.kill(_e.pid, e));
      }
    }, this.hook = () => {
...
function am(t, e, r = V$) {
  ...
  try {
    ...
    i = Ve.retry.openSync(s)(o, "w", r.mode || pl), r.tmpCreated && r.tmpCreated(o), $l(e) ? Ve.retry.writeSync(s)(i, e, 0, r.encoding || D$) : Va(e) || Ve.retry.writeSync(s)(i, e, 0, e.length, 0), r.fsync !== !1 && (r.fsyncWait !== !1 ? Ve.retry.fsyncSync(s)(i) : Ve.attempt.fsync(i)), Ve.retry.closeSync(s)(i), i = null, r.chown && (r.chown.uid !== F$ || r.chown.gid !== q$) && Ve.attempt.chownSync(o, r.chown.uid, r.chown.gid), r.mode && r.mode !== pl && Ve.attempt.chmodSync(o, r.mode);
    try {
      Ve.retry.renameSync(s)(o, t);
    } catch (_) {
      if (!B$(_) || _.code !== "ENAMETOOLONG")
        throw _;
...
var io = { exports: {} }, im = {}, pt = {}, on = {}, ts = {}, se = {}, Hn = {};
(function(t) {
...
V.toHash = J$;
function W$(t, e) {
  return typeof e == "boolean" ? e : Object.keys(e).length === 0 ? !0 : (cm(t, e), !lm(e, t.self.RULES.all));
}
V.alwaysValidSchema = W$;
function cm(t, e = t.schema) {
  const { opts: r, self: n } = t;
  if (!r.strictSchema || typeof e == "boolean")
    return;
  const s = n.RULES.keywords;
  for (const a in e)
    s[a] || fm(t, `unknown keyword: "${a}"`);
}
V.checkUnknownRules = cm;
function lm(t, e) {
  if (typeof t == "boolean")
    return !t;
  for (const r in t)
...
V.schemaHasRulesButRef = X$;
function Y$({ topSchemaRef: t, schemaPath: e }, r, n, s) {
  if (!s) {
...
V.schemaRefOrVal = Y$;
function Z$(t) {
  return um(decodeURIComponent(t));
}
V.unescapeFragment = Z$;
function eg(t) {
  return encodeURIComponent(Yo(t));
}
V.escapeFragment = eg;
function Yo(t) {
  return typeof t == "number" ? `${t}` : t.replace(/~/g, "~0").replace(/\//g, "~1");
}
V.escapeJsonPointer = Yo;
function um(t) {
  return t.replace(/~1/g, "/").replace(/~0/g, "~");
}
V.unescapeJsonPointer = um;
function tg(t, e) {
  if (Array.isArray(t))
    for (const r of t)
      e(r);
...
V.mergeEvaluated = {
  props: gl({
    ...
    mergeToName: (t, e, r) => t.if((0, me._)`${r} !== true`, () => {
      e === !0 ? t.assign(r, !0) : (t.assign(r, (0, me._)`${r} || {}`), Zo(t, r, e));
    }),
...
function dm(t, e) {
  ...
  return e !== void 0 && Zo(t, r, e), r;
}
V.evaluatedPropsToName = dm;
function Zo(t, e, r) {
...
function rg(t, e) {
  return t.scopeValue("func", {
    ref: e,
    code: vl[e.code] || (vl[e.code] = new H$._Code(e.code))
  });
}
V.useFunc = rg;
var lo;
...
function ng(t, e, r) {
  ...
  return r ? (0, me.getProperty)(t).toString() : "/" + Yo(t);
}
V.getErrorPath = ng;
function fm(t, e, r = t.opts.strictSchema) {
  if (r) {
...
const ag = ts, og = se, ig = nt, cg = {
  message: "boolean schema is false"
};
function lg(t) {
  const { gen: e, schema: r, validateName: n } = t;
  r === !1 ? hm(t, !1) : typeof r == "object" && r.$async === !0 ? e.return(ig.default.data) : (e.assign((0, og._)`${n}.errors`, null), e.return(!0));
}
on.topBoolOrEmptySchema = lg;
function ug(t, e) {
  const { gen: r, schema: n } = t;
  n === !1 ? (r.var(e, !1), hm(t)) : r.var(e, !0);
}
on.boolOrEmptySchema = ug;
function hm(t, e) {
  ...
  (0, ag.reportError)(s, cg, void 0, e);
}
var Ne = {}, Or = {};
Object.defineProperty(Or, "__esModule", { value: !0 });
Or.getRules = Or.isJSONType = void 0;
const dg = ["string", "number", "integer", "boolean", "null", "object", "array"], fg = new Set(dg);
function hg(t) {
...
function pg({ schema: t, self: e }, r) {
  const n = e.RULES.types[r];
  return n && n !== !0 && mm(t, n);
}
jt.schemaHasRulesForType = pg;
function mm(t, e) {
  return e.rules.some((r) => pm(t, r));
}
jt.shouldUseGroup = mm;
function pm(t, e) {
  var r;
...
const yg = Or, $g = jt, gg = ts, ae = se, ym = V;
var en;
(function(t) {
...
Ne.getSchemaTypes = vg;
function $m(t) {
  const e = Array.isArray(t) ? t : t ? [t] : [];
  if (e.every(yg.isJSONType))
    return e;
  throw new Error("type must be JSONType or JSONType[]: " + e.join(","));
}
Ne.getJSONTypes = $m;
function _g(t, e) {
  const { gen: r, data: n, opts: s } = t, a = wg(e, s.coerceTypes), o = e.length > 0 && !(a.length === 0 && e.length === 1 && (0, $g.schemaHasRulesForType)(t, e[0]));
  if (o) {
    const i = ei(e, n, s.strictNumbers, en.Wrong);
    r.if(i, () => {
      a.length ? bg(t, e, a) : ti(t);
    });
  }
  return o;
}
Ne.coerceAndCheckDataType = _g;
const gm = /* @__PURE__ */ new Set(["string", "number", "integer", "boolean", "null"]);
function wg(t, e) {
  return e ? t.filter((r) => gm.has(r) || e === "array" && r === "array") : [];
}
function bg(t, e, r) {
  const { gen: n, data: s, opts: a } = t, o = n.let("dataType", (0, ae._)`typeof ${s}`), i = n.let("coerced", (0, ae._)`undefined`);
  a.coerceTypes === "array" && n.if((0, ae._)`${o} == 'object' && Array.isArray(${s}) && ${s}.length == 1`, () => n.assign(s, (0, ae._)`${s}[0]`).assign(o, (0, ae._)`typeof ${s}`).if(ei(e, s, a.strictNumbers), () => n.assign(i, s))), n.if((0, ae._)`${i} !== undefined`);
  for (const d of r)
    (gm.has(d) || d === "array" && a.coerceTypes === "array") && c(d);
  n.else(), ti(t), n.endIf(), n.if((0, ae._)`${i} !== undefined`, () => {
    n.assign(s, i), Sg(t, i);
  });
  function c(d) {
    switch (d) {
...
function Sg({ gen: t, parentData: e, parentDataProperty: r }, n) {
...
function ti(t) {
  const e = Ng(t);
  (0, gg.reportError)(e, Eg);
}
Ne.reportTypeError = ti;
function Ng(t) {
  const { gen: e, data: r, schema: n } = t, s = (0, ym.schemaRefOrVal)(t, n, "type");
  return {
    gen: e,
    keyword: "type",
    data: r,
...
function Tg(t, e) {
  ...
  if (e === "object" && r)
    for (const s in r)
      _l(t, s, r[s].default);
  else e === "array" && Array.isArray(n) && n.forEach((s, a) => _l(t, a, s.default));
}
da.assignDefaults = Tg;
function _l(t, e, r) {
  ...
  if (s) {
    (0, Pg.checkStrictMode)(t, `default is ignored for: ${i}`);
    return;
  }
...
const ye = se, ri = V, zt = nt, Og = V;
function Rg(t, e) {
  const { gen: r, data: n, it: s } = t;
  r.if(si(r, n, e, s.opts.ownProperties), () => {
    t.setParams({ missingProperty: (0, ye._)`${e}` }, !0), t.error();
  });
}
ce.checkReportMissingProp = Rg;
function Ig({ gen: t, data: e, it: { opts: r } }, n, s) {
  return (0, ye.or)(...n.map((a) => (0, ye.and)(si(t, e, a, r.ownProperties), (0, ye._)`${s} = ${a}`)));
}
ce.checkMissingProp = Ig;
function jg(t, e) {
  t.setParams({ missingProperty: e }, !0), t.error();
}
ce.reportMissingProp = jg;
function vm(t) {
  return t.scopeValue("func", {
...
ce.hasPropFunc = vm;
function ni(t, e, r) {
  return (0, ye._)`${vm(t)}.call(${e}, ${r})`;
}
ce.isOwnProperty = ni;
function Cg(t, e, r, n) {
  const s = (0, ye._)`${e}${(0, ye.getProperty)(r)} !== undefined`;
  return n ? (0, ye._)`${s} && ${ni(t, e, r)}` : s;
}
ce.propertyInData = Cg;
function si(t, e, r, n) {
  const s = (0, ye._)`${e}${(0, ye.getProperty)(r)} === undefined`;
  return n ? (0, ye.or)(s, (0, ye.not)(ni(t, e, r))) : s;
}
ce.noPropertyInData = si;
function _m(t) {
  return t ? Object.keys(t).filter((e) => e !== "__proto__") : [];
}
ce.allSchemaProperties = _m;
function Ag(t, e) {
  return _m(e).filter((r) => !(0, ri.alwaysValidSchema)(t, e[r]));
}
ce.schemaProperties = Ag;
function kg({ schemaCode: t, data: e, it: { gen: r, topSchemaRef: n, schemaPath: s, errorPath: a }, it: o }, i, c, d) {
...
ce.callValidateCode = kg;
const Lg = (0, ye._)`new RegExp`;
function Dg({ gen: t, it: { opts: e } }, r) {
  const n = e.unicodeRegExp ? "u" : "", { regExp: s } = e.code, a = s(r, n);
  return t.scopeValue("pattern", {
    key: a.toString(),
    ref: a,
    code: (0, ye._)`${s.code === "new RegExp" ? Lg : (0, Og.useFunc)(t, s)}(${r}, ${n})`
  });
}
ce.usePattern = Dg;
function Mg(t) {
...
function Vg(t) {
  ...
  if (!Array.isArray(r))
    throw new Error("ajv implementation error");
  if (r.some((c) => (0, ri.alwaysValidSchema)(s, c)) && !s.opts.unevaluated)
    return;
...
const Be = se, gr = nt, Fg = ce, qg = ts;
function zg(t, e) {
  const { gen: r, keyword: n, schema: s, parentSchema: a, it: o } = t, i = e.macro.call(o.self, s, a, o), c = wm(r, n, i);
...
bt.macroKeywordCode = zg;
function Ug(t, e) {
  var r;
  const { gen: n, keyword: s, schema: a, parentSchema: o, $data: i, it: c } = t;
  Kg(c, e);
  const d = !i && e.compile ? e.compile.call(c.self, a, o, c) : e.validate, l = wm(n, s, d), h = n.let("valid");
  t.block$data(h, _), t.ok((r = e.valid) !== null && r !== void 0 ? r : h);
  function _() {
    if (e.errors === !1)
      v(), e.modifying && wl(t), g(() => t.error());
    else {
      const m = e.async ? $() : w();
      e.modifying && wl(t), g(() => Bg(t, m));
    }
  }
  function $() {
  ...
  function v(m = e.async ? (0, Be._)`await ` : Be.nil) {
    ...
    n.assign(h, (0, Be._)`${m}${(0, Fg.callValidateCode)(t, l, b, T)}`, e.modifying);
  }
  function g(m) {
    var b;
...
function Bg(t, e) {
  ...
  r.if((0, Be._)`Array.isArray(${e})`, () => {
    r.assign(gr.default.vErrors, (0, Be._)`${gr.default.vErrors} === null ? ${e} : ${gr.default.vErrors}.concat(${e})`).assign(gr.default.errors, (0, Be._)`${gr.default.vErrors}.length`), (0, qg.extendErrors)(t);
  }, () => t.error());
}
function Kg({ schemaEnv: t }, e) {
  if (e.async && !t.$async)
...
bt.validSchemaType = Qg;
function Gg({ schema: t, opts: e, self: r, errSchemaPath: n }, s, a) {
...
bt.validateKeywordUsage = Gg;
var Yt = {};
Object.defineProperty(Yt, "__esModule", { value: !0 });
Yt.extendSubschemaMode = Yt.extendSubschemaData = Yt.getSubschema = void 0;
const _t = se, bm = V;
function xg(t, { keyword: e, schemaProp: r, schema: n, schemaPath: s, errSchemaPath: a, topSchemaRef: o }) {
  ...
  if (e !== void 0) {
    ...
    return r === void 0 ? {
      ...
      errSchemaPath: `${t.errSchemaPath}/${e}/${(0, bm.escapeFragment)(r)}`
    };
  }
  if (n !== void 0) {
...
Yt.getSubschema = xg;
function Hg(t, e, { dataProp: r, dataPropType: n, data: s, dataTypes: a, propertyName: o }) {
  if (s !== void 0 && r !== void 0)
    throw new Error('both "data" and "dataProp" passed, only one allowed');
  const { gen: i } = e;
  if (r !== void 0) {
    const { errorPath: d, dataPathArr: l, opts: h } = e, _ = i.let("data", (0, _t._)`${e.data}${(0, _t.getProperty)(r)}`, !0);
    c(_), t.errorPath = (0, _t.str)`${d}${(0, bm.getErrorPath)(r, n, h.jsPropertySyntax)}`, t.parentDataProperty = (0, _t._)`${r}`, t.dataPathArr = [...l, t.parentDataProperty];
  }
  if (s !== void 0) {
...
Yt.extendSubschemaData = Hg;
function Jg(t, { jtdDiscriminator: e, jtdMetadata: r, compositeRule: n, createErrors: s, allErrors: a }) {
  n !== void 0 && (t.compositeRule = n), s !== void 0 && (t.createErrors = s), a !== void 0 && (t.allErrors = a), t.jtdDiscriminator = e, t.jtdMetadata = r;
}
Yt.extendSubschemaMode = Jg;
var je = {}, fa = function t(e, r) {
  ...
  return e !== e && r !== r;
}, Sm = { exports: {} }, Jt = Sm.exports = function(t, e, r) {
...
const Yg = V, Zg = fa, e0 = Xg, t0 = /* @__PURE__ */ new Set([
  "type",
  "format",
  "pattern",
  "maxLength",
...
function r0(t, e = !0) {
  return typeof t == "boolean" ? !0 : e === !0 ? !fo(t) : e ? Em(t) <= e : !1;
}
je.inlineRef = r0;
...
function Em(t) {
  ...
  for (const r in t) {
    if (r === "$ref")
      return 1 / 0;
    if (e++, !t0.has(r) && (typeof t[r] == "object" && (0, Yg.eachItem)(t[r], (n) => e += Em(n)), e === 1 / 0))
      return 1 / 0;
  }
  return e;
}
...
function i0(t, e) {
  if (typeof t == "boolean")
    return {};
  const { schemaId: r, uriResolver: n } = this.opts, s = tn(t[r] || e), a = { "": s }, o = Nm(n, s, !1), i = {}, c = /* @__PURE__ */ new Set();
  return e0(t, { allKeys: !0 }, (h, _, $, w) => {
    if (w === void 0)
      return;
    const v = o + _;
    let g = a[w];
...
const Tm = on, bl = Ne, ai = jt, Qs = Ne, c0 = da, Mn = bt, Fa = Yt, H = se, te = nt, l0 = je, Ct = V, Tn = ts;
function u0(t) {
  if (Im(t) && (jm(t), Rm(t))) {
    h0(t);
    return;
  }
  Om(t, () => (0, Tm.topBoolOrEmptySchema)(t));
}
pt.validateFunctionCode = u0;
function Om({ gen: t, validateName: e, schema: r, schemaEnv: n, opts: s }, a) {
  s.code.es5 ? t.func(e, (0, H._)`${te.default.data}, ${te.default.valCxt}`, n.$async, () => {
    t.code((0, H._)`"use strict"; ${Sl(r, s)}`), f0(t, s), t.code(a);
  }) : t.func(e, (0, H._)`${te.default.data}, ${d0(s)}`, n.$async, () => t.code(Sl(r, s)).code(a));
}
function d0(t) {
...
function h0(t) {
  ...
  Om(t, () => {
    r.$comment && e.$comment && Am(t), g0(t), n.let(te.default.vErrors, null), n.let(te.default.errors, 0), r.unevaluated && m0(t), Cm(t), w0(t);
  });
}
function m0(t) {
...
function p0(t, e) {
  ...
  (0, Tm.boolOrEmptySchema)(t, e);
}
function Rm({ schema: t, self: e }) {
  if (typeof t == "boolean")
    return !t;
  for (const r in t)
    if (e.RULES.all[r])
...
function y0(t, e) {
  ...
  s.$comment && r.$comment && Am(t), v0(t), _0(t);
  const a = n.const("_errs", te.default.errors);
  Cm(t, a), n.var(e, (0, H._)`${a} === ${te.default.errors}`);
}
function jm(t) {
  (0, Ct.checkUnknownRules)(t), $0(t);
}
function Cm(t, e) {
  if (t.opts.jtd)
    return El(t, [], !1, e);
  const r = (0, bl.getSchemaTypes)(t.schema), n = (0, bl.coerceAndCheckDataType)(t, r);
  El(t, r, !n, e);
}
function $0(t) {
...
function v0(t) {
  ...
  e && (t.baseId = (0, l0.resolveUrl)(t.opts.uriResolver, t.baseId, e));
}
function _0(t) {
  if (t.schema.$async && !t.schemaEnv.$async)
    throw new Error("async schema in sync schema");
}
function Am({ gen: t, schemaEnv: e, schema: r, errSchemaPath: n, opts: s }) {
  const a = r.$comment;
  if (s.$comment === !0)
...
function w0(t) {
  ...
  r.$async ? e.if((0, H._)`${te.default.errors} === 0`, () => e.return(te.default.data), () => e.throw((0, H._)`new ${s}(${te.default.vErrors})`)) : (e.assign((0, H._)`${n}.errors`, te.default.vErrors), a.unevaluated && b0(t), e.return((0, H._)`${te.default.errors} === 0`));
}
function b0({ gen: t, evaluated: e, props: r, items: n }) {
...
function El(t, e, r, n) {
  ...
  c.jtd || S0(t, e), s.block(() => {
    for (const _ of l.rules)
      h(_);
    h(l.post);
  });
  function h(_) {
    (0, ai.shouldUseGroup)(a, _) && (_.type ? (s.if((0, Qs.checkDataType)(_.type, o, c.strictNumbers)), Nl(t, _), e.length === 1 && e[0] === _.type && r && (s.else(), (0, Qs.reportTypeError)(t)), s.endIf()) : Nl(t, _), i || s.if((0, H._)`${te.default.errors} === ${n || 0}`));
  }
}
function Nl(t, e) {
  const { gen: r, schema: n, opts: { useDefaults: s } } = t;
  s && (0, c0.assignDefaults)(t, e.type), r.block(() => {
    for (const a of e.rules)
      (0, ai.shouldUseRule)(n, a) && Dm(t, a.keyword, a.definition, e.type);
  });
}
function S0(t, e) {
  t.schemaEnv.meta || !t.opts.strictTypes || (E0(t, e), t.opts.allowUnionTypes || N0(t, e), P0(t, t.dataTypes));
}
function E0(t, e) {
  if (e.length) {
    ...
    e.forEach((r) => {
      km(t.dataTypes, r) || oi(t, `type "${r}" not allowed by context "${t.dataTypes.join(",")}"`);
    }), O0(t, e);
  }
}
function N0(t, e) {
...
function P0(t, e) {
  ...
  for (const n in r) {
    const s = r[n];
    if (typeof s == "object" && (0, ai.shouldUseRule)(t.schema, s)) {
      const { type: a } = s.definition;
      a.length && !a.some((o) => T0(e, o)) && oi(t, `missing type "${a.join(",")}" for keyword "${n}"`);
    }
  }
}
function T0(t, e) {
...
function O0(t, e) {
  ...
  for (const n of t.dataTypes)
    km(e, n) ? r.push(n) : e.includes("integer") && n === "number" && r.push("integer");
  t.dataTypes = r;
}
function oi(t, e) {
...
const ct = se, A0 = rs, yr = nt, ht = je, Pl = V, k0 = pt;
let ha = class {
  constructor(e) {
    var r;
...
function ii(t) {
  ...
  let l;
  try {
    this._compilations.add(t), (0, k0.validateFunctionCode)(d), o.optimize(this.opts.code.optimize);
    const h = o.toString();
...
function L0(t, e, r) {
  ...
  if (s)
    return s;
  let a = V0.call(this, t, r);
  if (a === void 0) {
    const o = (n = t.localRefs) === null || n === void 0 ? void 0 : n[r], { schemaId: i } = this.opts;
    o && (a = new ha({ schema: o, schemaId: i, root: t, baseId: e }));
  }
  if (a !== void 0)
    return t.refs[r] = D0.call(this, a);
}
Ge.resolveRef = L0;
function D0(t) {
  return (0, ht.inlineRef)(t.schema, this.opts.inlineRefs) ? t.schema : t.validate ? t : ii.call(this, t);
}
function Vm(t) {
...
function ma(t, e) {
  ...
  if (typeof (o == null ? void 0 : o.schema) == "object") {
    if (o.validate || ii.call(this, o), a === (0, ht.normalizeId)(e)) {
...
function za(t, { baseId: e, schema: r, root: n }) {
  ...
  for (const i of t.fragment.slice(1).split("/")) {
    if (typeof r == "boolean")
      return;
    const c = r[(0, Pl.unescapeFragment)(i)];
    if (c === void 0)
      return;
    r = c;
    const d = typeof r == "object" && r[this.opts.schemaId];
    !F0.has(i) && d && (e = (0, ht.resolveUrl)(this.opts.uriResolver, e, d));
  }
  let a;
  if (typeof r != "boolean" && r.$ref && !(0, Pl.schemaHasRulesButRef)(r, this.RULES)) {
...
const q0 = "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#", z0 = "Meta-schema for $data reference (JSON AnySchema extension proposal)", U0 = "object", B0 = [
  "$data"
], K0 = {
  $data: {
    type: "string",
  ...
  required: B0,
  properties: K0,
  additionalProperties: Q0
};
var ci = {}, pa = { exports: {} };
const x0 = RegExp.prototype.test.bind(/^[\da-f]{8}-[\da-f]{4}-[\da-f]{4}-[\da-f]{4}-[\da-f]{12}$/iu), Fm = RegExp.prototype.test.bind(/^(?:(?:25[0-5]|2[0-4]\d|1\d{2}|[1-9]\d|\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d{2}|[1-9]\d|\d)$/u), li = RegExp.prototype.test.bind(/^[\da-f]{2}$/iu), qm = RegExp.prototype.test.bind(/^[\da-z\-._~]$/iu), H0 = RegExp.prototype.test.bind(/^[\da-z\-._~!$&'()*+,;=:@/]$/iu);
function zm(t) {
  let e = "", r = 0, n = 0;
...
const J0 = RegExp.prototype.test.bind(/[^!"$&'()*+,\-.;=_`a-z{}~]/u);
function Tl(t) {
  return t.length = 0, !0;
}
function W0(t, e, r) {
...
function X0(t) {
  ...
  return s.length && (i === Tl ? r.zone = s.join("") : o ? n.push(s.join("")) : n.push(zm(s))), r.address = n.join(""), r;
}
function Um(t) {
  if (Y0(t, ":") < 2)
...
const ev = { "@": "%40", "/": "%2F", "?": "%3F", "#": "%23", ":": "%3A" }, tv = /[@/?#:]/g, rv = /[@/?#]/g;
function Bm(t, e) {
  const r = e ? rv : tv;
  return r.lastIndex = 0, t.replace(r, (n) => ev[n]);
}
function nv(t, e = !1) {
  if (t.indexOf("%") === -1)
    return t;
...
function ov(t) {
  ...
  if (t.userinfo !== void 0 && (e.push(t.userinfo), e.push("@")), t.host !== void 0) {
    ...
    if (!Fm(r)) {
      const n = Um(r);
      n.isIPV6 === !0 ? r = `[${n.escapedHost}]` : r = Bm(r, !1);
    }
    e.push(r);
  }
...
var Km = {
  nonSimpleDomain: J0,
  recomposeAuthority: ov,
  reescapeHostDelimiters: Bm,
  normalizePercentEncoding: nv,
  normalizePathEncoding: sv,
  escapePreservingEscapes: av,
  removeDotSegments: Z0,
  isIPv4: Fm,
  isUUID: x0,
  normalizeIPv6: Um
};
const { isUUID: iv } = Km, cv = /([\da-z][\d\-a-z]{0,31}):((?:[\w!$'()*+,\-.:;=@]|%[\da-f]{2})+)/iu;
function Qm(t) {
...
function fv(t, e) {
  ...
  const r = e.scheme || t.scheme || "urn", n = t.nid.toLowerCase(), s = `${r}:${e.nid || n}`, a = ui(s);
  a && (t = a.serialize(t, e));
  const o = t, i = t.nss;
...
function hv(t, e) {
  const r = t;
  return r.uuid = r.nss, r.nss = void 0, !e.tolerant && (!r.uuid || !iv(r.uuid)) && (r.error = r.error || "UUID is not valid."), r;
}
function mv(t) {
  const e = t;
...
const { normalizeIPv6: _v, removeDotSegments: Cn, recomposeAuthority: wv, normalizePercentEncoding: bv, normalizePathEncoding: Sv, escapePreservingEscapes: Ev, reescapeHostDelimiters: Nv, isIPv4: Pv, nonSimpleDomain: Tv } = Km, { SCHEMES: Ov, getSchemeHandler: Jm } = vv;
function Rv(t, e) {
  return typeof t == "string" ? t = /** @type {T} */
  kv(t, e) : typeof t == "object" && (t = /** @type {T} */
  cn(Rr(t, e), e)), t;
}
function Iv(t, e, r) {
  const n = r ? Object.assign({ scheme: "null" }, r) : { scheme: "null" }, s = Wm(cn(t, n), cn(e, n), n, !0);
...
function Rr(t, e) {
  const r = {
    ...
    secure: t.secure,
    error: ""
  }, n = Object.assign({}, e), s = [], a = Jm(n.scheme || r.scheme);
  a && a.serialize && a.serialize(r, n), r.path !== void 0 && (n.skipEscape ? r.path = bv(r.path) : (r.path = Ev(r.path), r.scheme !== void 0 && (r.path = r.path.split("%3A").join(":")))), n.reference !== "suffix" && r.scheme && s.push(r.scheme, ":");
  const o = wv(r);
...
function Xm(t, e) {
  ...
  if (o) {
    ...
    if ((!c || c && !c.skipNormalize) && (t.indexOf("%") !== -1 && (n.scheme !== void 0 && (n.scheme = unescape(n.scheme)), n.host !== void 0 && (n.host = Nv(unescape(n.host), a))), n.path && (n.path = Sv(n.path)), n.fragment))
      try {
...
function cn(t, e) {
  return Xm(t, e).parsed;
}
function kv(t, e) {
  return Ym(t, e).normalized;
}
function Ym(t, e) {
  const { parsed: r, malformedAuthorityOrPort: n } = Xm(t, e);
  return {
...
function Ol(t, e) {
  if (typeof t == "string") {
    const { normalized: r, malformedAuthorityOrPort: n } = Ym(t, e);
    return n ? void 0 : r;
  }
  if (typeof t == "object")
    return Rr(t, e);
...
pa.exports = di;
pa.exports.default = di;
pa.exports.fastUri = di;
var Zm = pa.exports;
...
(function(t) {
  ...
  const n = rs, s = mn, a = Or, o = Ge, i = se, c = je, d = Ne, l = V, h = G0, _ = ci, $ = (P, p) => new RegExp(P, p);
  $.code = "new RegExp";
...
const Dv = mn, Rl = ce, He = se, zr = nt, Il = Ge, fs = V, Mv = {
  keyword: "$ref",
  schemaType: "string",
  code(t) {
    ...
    if ((r === "#" || r === "#/") && s === d.baseId)
      return h();
    const l = Il.resolveRef.call(c, d, s, r);
    if (l === void 0)
      throw new Dv.default(n.opts.uriResolver, s, r);
    if (l instanceof Il.SchemaEnv)
      return _(l);
    return $(l);
    function h() {
      if (a === d)
...
function ks(t, e, r, n) {
  ...
  function l() {
    ...
    const w = s.let("valid");
    s.try(() => {
      s.code((0, He._)`await ${(0, Rl.callValidateCode)(t, e, d)}`), $(e), o || s.assign(w, !0);
    }, (v) => {
      s.if((0, He._)`!(${v} instanceof ${a.ValidationError})`, () => s.throw(v)), _(v), o || s.assign(w, !1);
    }), t.ok(w);
  }
  function h() {
    t.result((0, Rl.callValidateCode)(t, e, d), () => $(e), () => _(e));
  }
  function _(w) {
...
const vr = se, Qv = V, Gv = vi, xv = {
  ...
  error: xv,
  code(t) {
    const { keyword: e, data: r, schemaCode: n, it: s } = t, a = e === "maxLength" ? vr.operators.GT : vr.operators.LT, o = s.opts.unicode === !1 ? (0, vr._)`${r}.length` : (0, vr._)`${(0, Qv.useFunc)(t.gen, Gv.default)}(${r})`;
...
const Jv = ce, Wv = V, Xr = se, Xv = {
  ...
  code(t) {
    ...
    if (n) {
      const { regExp: c } = o.opts.code, d = c.code === "new RegExp" ? (0, Xr._)`new RegExp` : (0, Wv.useFunc)(e, c), l = e.let("valid");
      e.try(() => e.assign(l, (0, Xr._)`${d}(${a}, ${i}).test(${r})`), () => e.assign(l, !1)), t.fail$data((0, Xr._)`!${l}`);
    } else {
      const c = (0, Jv.usePattern)(t, s);
...
const np = fa;
np.code = 'require("ajv/dist/runtime/equal").default';
ns.default = np;
Object.defineProperty(Ei, "__esModule", { value: !0 });
const Ua = Ne, Re = se, o_ = V, i_ = ns, c_ = {
  ...
  code(t) {
    ...
    function $(w, v) {
      const g = (0, o_.useFunc)(e, i_.default), m = e.name("outer");
...
const ho = se, u_ = V, d_ = ns, f_ = {
  ...
  code(t) {
    ...
    n || a && typeof a == "object" ? t.fail$data((0, ho._)`!${(0, u_.useFunc)(e, d_.default)}(${r}, ${s})`) : t.fail((0, ho._)`${a} !== ${r}`);
  }
};
Ni.default = h_;
var Pi = {};
Object.defineProperty(Pi, "__esModule", { value: !0 });
const An = se, m_ = V, p_ = ns, y_ = {
  ...
  code(t) {
    ...
    let c;
    const d = () => c ?? (c = (0, m_.useFunc)(e, p_.default));
    let l;
    if (i || n)
...
Pi.default = $_;
Object.defineProperty(pi, "__esModule", { value: !0 });
const g_ = yi, v_ = $i, __ = gi, w_ = _i, b_ = wi, S_ = bi, E_ = Si, N_ = Ei, P_ = Ni, T_ = Pi, O_ = [
  // number
  g_.default,
  v_.default,
  // string
...
pn.validateAdditionalItems = sp;
pn.default = I_;
var Oi = {}, yn = {};
Object.defineProperty(yn, "__esModule", { value: !0 });
yn.validateTuple = void 0;
const jl = se, Ls = V, j_ = ce, C_ = {
  keyword: "items",
  type: "array",
  ...
  code(t) {
    ...
    if (Array.isArray(e))
      return ap(t, "additionalItems", e);
    r.items = !0, !(0, Ls.alwaysValidSchema)(r, e) && t.ok((0, j_.validateArray)(t));
  }
};
function ap(t, e, r = t.schema) {
  ...
  r.forEach((h, _) => {
    (0, Ls.alwaysValidSchema)(i, h) || (n.if((0, jl._)`${d} > ${_}`, () => t.subschema({
      keyword: o,
      schemaProp: _,
      dataProp: _
    }, c)), t.ok(c));
...
const A_ = yn, k_ = {
  ...
  schemaType: ["array"],
  before: "uniqueItems",
  code: (t) => (0, A_.validateTuple)(t, "items")
};
Oi.default = k_;
var Ri = {};
Object.defineProperty(Ri, "__esModule", { value: !0 });
const Cl = se, L_ = V, D_ = ce, M_ = pn, V_ = {
  message: ({ params: { len: t } }) => (0, Cl.str)`must NOT have more than ${t} items`,
  params: ({ params: { len: t } }) => (0, Cl._)`{limit: ${t}}`
}, F_ = {
  keyword: "items",
  type: "array",
  ...
  code(t) {
    ...
    n.items = !0, !(0, L_.alwaysValidSchema)(n, e) && (s ? (0, M_.validateAdditionalItems)(t, s) : t.ok((0, D_.validateArray)(t)));
  }
};
Ri.default = F_;
var Ii = {};
...
const op = se, U_ = V, B_ = {
  ...
  params: ({ params: t }) => (0, op._)`{propertyName: ${t.propertyName}}`
}, K_ = {
...
const ms = ce, ut = se, Q_ = nt, ps = V, G_ = {
  ...
  code(t) {
    ...
    h(), t.ok((0, ut._)`${a} === ${Q_.default.errors}`);
    function h() {
      e.forIn("key", s, (g) => {
...
var Ci = {};
Object.defineProperty(Ci, "__esModule", { value: !0 });
const H_ = pt, Al = ce, Ba = V, kl = $a, J_ = {
  keyword: "properties",
  type: "object",
  schemaType: "object",
  code(t) {
    const { gen: e, schema: r, parentSchema: n, data: s, it: a } = t;
    a.opts.removeAdditional === "all" && n.additionalProperties === void 0 && kl.default.code(new H_.KeywordCxt(a, kl.default, "additionalProperties"));
    const o = (0, Al.allSchemaProperties)(r);
    for (const h of o)
    ...
    for (const h of i)
      d(h) ? l(h) : (e.if((0, Al.propertyInData)(e, s, h, a.opts.ownProperties)), l(h), a.allErrors || e.else().var(c, !0), e.endIf()), t.it.definedProperties.add(h), t.ok(c);
    function d(h) {
...
const Ll = ce, ys = se, Dl = V, Ml = V, W_ = {
  keyword: "patternProperties",
  type: "object",
  schemaType: "object",
  code(t) {
    const { gen: e, schema: r, data: n, parentSchema: s, it: a } = t, { opts: o } = a, i = (0, Ll.allSchemaProperties)(r), c = i.filter((v) => (0, Dl.alwaysValidSchema)(a, r[v]));
    ...
    a.props !== !0 && !(a.props instanceof ys.Name) && (a.props = (0, Ml.evaluatedPropsToName)(e, a.props));
    const { props: h } = a;
    _();
    function _() {
      for (const v of i)
    ...
    function $(v) {
      for (const g in d)
        new RegExp(v).test(g) && (0, Dl.checkStrictMode)(a, `property ${g} matches pattern ${v} (use allowMatchingProperties)`);
    }
    function w(v) {
      e.forIn("key", n, (g) => {
        e.if((0, ys._)`${(0, Ll.usePattern)(t, v)}.test(${g})`, () => {
...
const Ds = se, tw = V, rw = {
  ...
  code(t) {
    ...
    function d() {
      a.forEach((l, h) => {
        let _;
        (0, tw.alwaysValidSchema)(s, l) ? e.var(c, !0) : _ = t.subschema({
          keyword: "oneOf",
          schemaProp: h,
          compositeRule: !0
...
const Js = se, ip = V, ow = {
  ...
  code(t) {
    ...
    r.then === void 0 && r.else === void 0 && (0, ip.checkStrictMode)(n, '"if" without "then" and "else" is ignored');
    const s = Vl(n, "then"), a = Vl(n, "else");
    if (!s && !a)
      return;
...
const cw = V, lw = {
  ...
  code({ keyword: t, parentSchema: e, it: r }) {
    e.if === void 0 && (0, cw.checkStrictMode)(r, `"${t}" without "if" is ignored`);
  }
};
Fi.default = lw;
Object.defineProperty(Ti, "__esModule", { value: !0 });
const uw = pn, dw = Oi, fw = yn, hw = Ri, mw = Ii, pw = ya, yw = ji, $w = $a, gw = Ci, vw = Ai, _w = ki, ww = Li, bw = Di, Sw = Mi, Ew = Vi, Nw = Fi;
function Pw(t = !1) {
  const e = [
    // any
    _w.default,
  ...
  return t ? e.push(dw.default, hw.default) : e.push(uw.default, fw.default), e.push(mw.default), e;
}
Ti.default = Pw;
var qi = {}, $n = {};
Object.defineProperty($n, "__esModule", { value: !0 });
$n.dynamicAnchor = void 0;
const Ka = se, Tw = nt, Fl = Ge, Ow = Dt, Rw = {
  keyword: "$dynamicAnchor",
  schemaType: "string",
  code: (t) => cp(t, t.schema)
};
function cp(t, e) {
  const { gen: r, it: n } = t;
  n.schemaEnv.root.dynamicAnchors[e] = !0;
  const s = (0, Ka._)`${Tw.default.dynamicAnchors}${(0, Ka.getProperty)(e)}`, a = n.errSchemaPath === "#" ? n.validateName : Iw(t);
  r.if((0, Ka._)`!${s}`, () => r.assign(s, a));
}
$n.dynamicAnchor = cp;
function Iw(t) {
  const { schemaEnv: e, schema: r, self: n } = t.it, { root: s, baseId: a, localRefs: o, meta: i } = e.root, { schemaId: c } = n.opts, d = new Fl.SchemaEnv({ schema: r, schemaId: c, root: s, baseId: a, localRefs: o, meta: i });
  return Fl.compileSchema.call(n, d), (0, Ow.getValidate)(t, d);
}
$n.default = Rw;
var gn = {};
Object.defineProperty(gn, "__esModule", { value: !0 });
gn.dynamicRef = void 0;
const ql = se, jw = nt, zl = Dt, Cw = {
  keyword: "$dynamicRef",
  schemaType: "string",
  code: (t) => lp(t, t.schema)
};
function lp(t, e) {
  ...
  function o(c) {
    if (s.schemaEnv.root.dynamicAnchors[a]) {
      const d = r.let("_v", (0, ql._)`${jw.default.dynamicAnchors}${(0, ql.getProperty)(a)}`);
...
const Aw = $n, kw = V, Lw = {
  ...
  schemaType: "boolean",
  code(t) {
    t.schema ? (0, Aw.dynamicAnchor)(t, "") : (0, kw.checkStrictMode)(t.it, "$recursiveAnchor: false is ignored");
  }
};
zi.default = Lw;
var Ui = {};
...
const Dw = gn, Mw = {
  ...
  schemaType: "string",
  code: (t) => (0, Dw.dynamicRef)(t, t.schema)
};
Ui.default = Mw;
Object.defineProperty(qi, "__esModule", { value: !0 });
const Vw = $n, Fw = gn, qw = zi, zw = Ui, Uw = [Vw.default, Fw.default, qw.default, zw.default];
qi.default = Uw;
var Bi = {}, Ki = {};
Object.defineProperty(Ki, "__esModule", { value: !0 });
const Ul = ya, Bw = {
  ...
  schemaType: "object",
  error: Ul.error,
  code: (t) => (0, Ul.validatePropertyDeps)(t)
};
Ki.default = Bw;
var Qi = {};
Object.defineProperty(Qi, "__esModule", { value: !0 });
const Kw = ya, Qw = {
  ...
  type: "object",
  schemaType: "object",
  code: (t) => (0, Kw.validateSchemaDeps)(t)
};
Qi.default = Qw;
var Gi = {};
Object.defineProperty(Gi, "__esModule", { value: !0 });
const Gw = V, xw = {
  ...
  schemaType: "number",
  code({ keyword: t, parentSchema: e, it: r }) {
    e.contains === void 0 && (0, Gw.checkStrictMode)(r, `"${t}" without "contains" is ignored`);
  }
};
Gi.default = xw;
Object.defineProperty(Bi, "__esModule", { value: !0 });
const Hw = Ki, Jw = Qi, Ww = Gi, Xw = [Hw.default, Jw.default, Ww.default];
Bi.default = Xw;
var xi = {}, Hi = {};
Object.defineProperty(Hi, "__esModule", { value: !0 });
const Qt = se, Bl = V, Yw = nt, Zw = {
  ...
  code(t) {
    ...
    i instanceof Qt.Name ? e.if((0, Qt._)`${i} !== true`, () => e.forIn("key", n, (h) => e.if(d(i, h), () => c(h)))) : i !== !0 && e.forIn("key", n, (h) => i === void 0 ? c(h) : e.if(l(i, h), () => c(h))), a.props = !0, t.ok((0, Qt._)`${s} === ${Yw.default.errors}`);
    function c(h) {
      if (r === !1) {
        t.setParams({ unevaluatedProperty: h }), t.error(), o || e.break();
        return;
      }
      if (!(0, Bl.alwaysValidSchema)(a, r)) {
...
const wr = se, Kl = V, tb = {
  ...
  code(t) {
    ...
    function i(c, d) {
      e.forRange("i", d, o, (l) => {
        t.subschema({ keyword: "unevaluatedItems", dataProp: l, dataPropType: Kl.Type.Num }, c), s.allErrors || e.if((0, wr.not)(c), () => e.break());
      });
    }
  }
};
...
const nb = Hi, sb = Ji, ab = [nb.default, sb.default];
xi.default = ab;
var Wi = {}, Xi = {};
Object.defineProperty(Xi, "__esModule", { value: !0 });
const we = se, ob = {
...
Object.defineProperty(fi, "__esModule", { value: !0 });
const ub = hi, db = pi, fb = Ti, hb = qi, mb = Bi, pb = xi, yb = Wi, Ql = ln, $b = [
  hb.default,
  ub.default,
  db.default,
  (0, fb.default)(!0),
  yb.default,
  Ql.metadataVocabulary,
  Ql.contentVocabulary,
  mb.default,
  pb.default
];
fi.default = $b;
...
Object.defineProperty(Yi, "__esModule", { value: !0 });
const Gr = se, po = ga, xl = Ge, gb = mn, vb = V, _b = {
  ...
  code(t) {
    ...
    function _() {
      ...
      for (let O = 0; O < o.length; O++) {
        let I = o[O];
        if (I != null && I.$ref && !(0, vb.schemaHasRulesButRef)(I, a.self.RULES)) {
          const D = I.$ref;
          if (I = xl.resolveRef.call(a.self, a.schemaEnv.root, a.baseId, D), I instanceof xl.SchemaEnv && (I = I.schema), I === void 0)
            throw new gb.default(a.opts.uriResolver, a.baseId, D);
        }
...
Yi.default = wb;
var Zi = {};
const bb = "https://json-schema.org/draft/2020-12/schema", Sb = "https://json-schema.org/draft/2020-12/schema", Eb = {
...
}, Nb = "meta", Pb = "Core and Validation specifications meta-schema", Tb = [
  {
    $ref: "meta/core"
  },
  {
  ...
  "object",
  "boolean"
], Rb = "This meta-schema also defines keywords that have appeared in previous drafts in order to prevent incompatible extensions as they remain in common use.", Ib = {
  definitions: {
  ...
  $comment: Rb,
  properties: Ib
}, Cb = "https://json-schema.org/draft/2020-12/schema", Ab = "https://json-schema.org/draft/2020-12/meta/applicator", kb = {
  "https://json-schema.org/draft/2020-12/vocab/applicator": !0
}, Lb = "meta", Db = "Applicator vocabulary meta-schema", Mb = [
  "object",
  "boolean"
], Vb = {
  prefixItems: {
  ...
  properties: Vb,
  $defs: Fb
}, zb = "https://json-schema.org/draft/2020-12/schema", Ub = "https://json-schema.org/draft/2020-12/meta/unevaluated", Bb = {
  "https://json-schema.org/draft/2020-12/vocab/unevaluated": !0
}, Kb = "meta", Qb = "Unevaluated applicator vocabulary meta-schema", Gb = [
  "object",
  "boolean"
], xb = {
  unevaluatedItems: {
  ...
  type: Gb,
  properties: xb
}, Jb = "https://json-schema.org/draft/2020-12/schema", Wb = "https://json-schema.org/draft/2020-12/meta/content", Xb = {
  "https://json-schema.org/draft/2020-12/vocab/content": !0
}, Yb = "meta", Zb = "Content vocabulary meta-schema", eS = [
  "object",
  "boolean"
], tS = {
  contentEncoding: {
  ...
  type: eS,
  properties: tS
}, nS = "https://json-schema.org/draft/2020-12/schema", sS = "https://json-schema.org/draft/2020-12/meta/core", aS = {
  "https://json-schema.org/draft/2020-12/vocab/core": !0
}, oS = "meta", iS = "Core vocabulary meta-schema", cS = [
  "object",
  "boolean"
], lS = {
  $id: {
  ...
  properties: lS,
  $defs: uS
}, fS = "https://json-schema.org/draft/2020-12/schema", hS = "https://json-schema.org/draft/2020-12/meta/format-annotation", mS = {
  "https://json-schema.org/draft/2020-12/vocab/format-annotation": !0
}, pS = "meta", yS = "Format vocabulary meta-schema for annotation results", $S = [
  "object",
  "boolean"
], gS = {
  format: {
  ...
  type: $S,
  properties: gS
}, _S = "https://json-schema.org/draft/2020-12/schema", wS = "https://json-schema.org/draft/2020-12/meta/meta-data", bS = {
  "https://json-schema.org/draft/2020-12/vocab/meta-data": !0
}, SS = "meta", ES = "Meta-data vocabulary meta-schema", NS = [
  "object",
  "boolean"
], PS = {
  title: {
  ...
  type: NS,
  properties: PS
}, OS = "https://json-schema.org/draft/2020-12/schema", RS = "https://json-schema.org/draft/2020-12/meta/validation", IS = {
  "https://json-schema.org/draft/2020-12/vocab/validation": !0
}, jS = "meta", CS = "Validation vocabulary meta-schema", AS = [
  "object",
  "boolean"
], kS = {
  type: {
...
Object.defineProperty(Zi, "__esModule", { value: !0 });
const MS = jb, VS = qb, FS = Hb, qS = rS, zS = dS, US = vS, BS = TS, KS = DS, QS = ["/properties"];
function GS(t) {
  return [
    MS,
    VS,
  ...
  function e(r, n) {
    return t ? r.$dataMetaSchema(n, QS) : n;
  }
}
Zi.default = GS;
(function(t, e) {
  ...
  const r = im, n = fi, s = Yi, a = Zi, o = "https://json-schema.org/draft/2020-12/schema";
...
var xS = io.exports, yo = { exports: {} }, up = {};
(function(t) {
...
var dp = {}, $o = { exports: {} }, fp = {}, yt = {}, un = {}, ss = {}, ie = {}, Jn = {};
(function(t) {
  Object.defineProperty(t, "__esModule", { value: !0 }), t.regexpCode = t.getEsmExportName = t.getProperty = t.safeStringify = t.stringify = t.strConcat = t.addCodeArg = t.str = t._ = t.nil = t._Code = t.Name = t.IDENTIFIER = t._CodeOrName = void 0;
  class e {
  }
...
z.toHash = JS;
function WS(t, e) {
  return typeof e == "boolean" ? e : Object.keys(e).length === 0 ? !0 : (hp(t, e), !mp(e, t.self.RULES.all));
}
z.alwaysValidSchema = WS;
function hp(t, e = t.schema) {
  const { opts: r, self: n } = t;
  if (!r.strictSchema || typeof e == "boolean")
    return;
  const s = n.RULES.keywords;
  for (const a in e)
    s[a] || $p(t, `unknown keyword: "${a}"`);
}
z.checkUnknownRules = hp;
function mp(t, e) {
  if (typeof t == "boolean")
    return !t;
  for (const r in t)
...
z.schemaHasRulesButRef = XS;
function YS({ topSchemaRef: t, schemaPath: e }, r, n, s) {
  if (!s) {
    if (typeof r == "number" || typeof r == "boolean")
      return r;
    if (typeof r == "string")
...
z.schemaRefOrVal = YS;
function ZS(t) {
  return pp(decodeURIComponent(t));
}
z.unescapeFragment = ZS;
function eE(t) {
...
z.escapeJsonPointer = ec;
function pp(t) {
  return t.replace(/~1/g, "/").replace(/~0/g, "~");
}
z.unescapeJsonPointer = pp;
function tE(t, e) {
  if (Array.isArray(t))
    for (const r of t)
      e(r);
...
z.eachItem = tE;
function Hl({ mergeNames: t, mergeToName: e, mergeValues: r, resultToName: n }) {
  return (s, a, o, i) => {
...
z.mergeEvaluated = {
  props: Hl({
    ...
    mergeToName: (t, e, r) => t.if((0, pe._)`${r} !== true`, () => {
      e === !0 ? t.assign(r, !0) : (t.assign(r, (0, pe._)`${r} || {}`), tc(t, r, e));
    }),
    mergeValues: (t, e) => t === !0 ? !0 : { ...t, ...e },
    resultToName: yp
  }),
...
function yp(t, e) {
  ...
  return e !== void 0 && tc(t, r, e), r;
}
z.evaluatedPropsToName = yp;
function tc(t, e, r) {
...
function rE(t, e) {
  return t.scopeValue("func", {
    ref: e,
    code: Jl[e.code] || (Jl[e.code] = new HS._Code(e.code))
  });
}
z.useFunc = rE;
var vo;
...
function nE(t, e, r) {
  ...
  return r ? (0, pe.getProperty)(t).toString() : "/" + ec(t);
}
z.getErrorPath = nE;
function $p(t, e, r = t.opts.strictSchema) {
  if (r) {
    if (e = `strict mode: ${e}`, r === !0)
      throw new Error(e);
    t.self.logger.warn(e);
...
const aE = ss, oE = ie, iE = Et, cE = {
  message: "boolean schema is false"
};
function lE(t) {
  const { gen: e, schema: r, validateName: n } = t;
  r === !1 ? gp(t, !1) : typeof r == "object" && r.$async === !0 ? e.return(iE.default.data) : (e.assign((0, oE._)`${n}.errors`, null), e.return(!0));
}
un.topBoolOrEmptySchema = lE;
function uE(t, e) {
  const { gen: r, schema: n } = t;
  n === !1 ? (r.var(e, !1), gp(t)) : r.var(e, !0);
}
un.boolOrEmptySchema = uE;
function gp(t, e) {
  const { gen: r, data: n } = t, s = {
    gen: r,
    keyword: "false schema",
  ...
  (0, aE.reportError)(s, cE, void 0, e);
}
var Pe = {}, Ir = {};
Object.defineProperty(Ir, "__esModule", { value: !0 });
Ir.getRules = Ir.isJSONType = void 0;
const dE = ["string", "number", "integer", "boolean", "null", "object", "array"], fE = new Set(dE);
function hE(t) {
...
function pE({ schema: t, self: e }, r) {
  const n = e.RULES.types[r];
  return n && n !== !0 && vp(t, n);
}
At.schemaHasRulesForType = pE;
function vp(t, e) {
  return e.rules.some((r) => _p(t, r));
}
At.shouldUseGroup = vp;
function _p(t, e) {
  var r;
  return t[e.keyword] !== void 0 || ((r = e.definition.implements) === null || r === void 0 ? void 0 : r.some((n) => t[n] !== void 0));
}
...
const yE = Ir, $E = At, gE = ss, oe = ie, wp = z;
var rn;
(function(t) {
  t[t.Correct = 0] = "Correct", t[t.Wrong = 1] = "Wrong";
})(rn || (Pe.DataType = rn = {}));
...
Pe.getSchemaTypes = vE;
function bp(t) {
  const e = Array.isArray(t) ? t : t ? [t] : [];
  if (e.every(yE.isJSONType))
    return e;
  throw new Error("type must be JSONType or JSONType[]: " + e.join(","));
}
Pe.getJSONTypes = bp;
function _E(t, e) {
  const { gen: r, data: n, opts: s } = t, a = wE(e, s.coerceTypes), o = e.length > 0 && !(a.length === 0 && e.length === 1 && (0, $E.schemaHasRulesForType)(t, e[0]));
  if (o) {
    const i = rc(e, n, s.strictNumbers, rn.Wrong);
    r.if(i, () => {
      a.length ? bE(t, e, a) : nc(t);
    });
  }
  return o;
}
Pe.coerceAndCheckDataType = _E;
const Sp = /* @__PURE__ */ new Set(["string", "number", "integer", "boolean", "null"]);
function wE(t, e) {
  return e ? t.filter((r) => Sp.has(r) || e === "array" && r === "array") : [];
}
function bE(t, e, r) {
  const { gen: n, data: s, opts: a } = t, o = n.let("dataType", (0, oe._)`typeof ${s}`), i = n.let("coerced", (0, oe._)`undefined`);
  a.coerceTypes === "array" && n.if((0, oe._)`${o} == 'object' && Array.isArray(${s}) && ${s}.length == 1`, () => n.assign(s, (0, oe._)`${s}[0]`).assign(o, (0, oe._)`typeof ${s}`).if(rc(e, s, a.strictNumbers), () => n.assign(i, s))), n.if((0, oe._)`${i} !== undefined`);
  for (const d of r)
    (Sp.has(d) || d === "array" && a.coerceTypes === "array") && c(d);
  n.else(), nc(t), n.endIf(), n.if((0, oe._)`${i} !== undefined`, () => {
    n.assign(s, i), SE(t, i);
  });
  function c(d) {
    switch (d) {
...
function SE({ gen: t, parentData: e, parentDataProperty: r }, n) {
...
function nc(t) {
  const e = NE(t);
  (0, gE.reportError)(e, EE);
}
Pe.reportTypeError = nc;
function NE(t) {
  const { gen: e, data: r, schema: n } = t, s = (0, wp.schemaRefOrVal)(t, n, "type");
  return {
    gen: e,
    keyword: "type",
    data: r,
...
const $e = ie, sc = z, Bt = Et, OE = z;
function RE(t, e) {
  const { gen: r, data: n, it: s } = t;
  r.if(oc(r, n, e, s.opts.ownProperties), () => {
    t.setParams({ missingProperty: (0, $e._)`${e}` }, !0), t.error();
  });
}
le.checkReportMissingProp = RE;
function IE({ gen: t, data: e, it: { opts: r } }, n, s) {
  return (0, $e.or)(...n.map((a) => (0, $e.and)(oc(t, e, a, r.ownProperties), (0, $e._)`${s} = ${a}`)));
}
le.checkMissingProp = IE;
function jE(t, e) {
  t.setParams({ missingProperty: e }, !0), t.error();
}
le.reportMissingProp = jE;
function Ep(t) {
  return t.scopeValue("func", {
    // eslint-disable-next-line @typescript-eslint/unbound-method
    ref: Object.prototype.hasOwnProperty,
...
le.hasPropFunc = Ep;
function ac(t, e, r) {
  return (0, $e._)`${Ep(t)}.call(${e}, ${r})`;
}
le.isOwnProperty = ac;
function CE(t, e, r, n) {
  const s = (0, $e._)`${e}${(0, $e.getProperty)(r)} !== undefined`;
  return n ? (0, $e._)`${s} && ${ac(t, e, r)}` : s;
}
le.propertyInData = CE;
function oc(t, e, r, n) {
  const s = (0, $e._)`${e}${(0, $e.getProperty)(r)} === undefined`;
  return n ? (0, $e.or)(s, (0, $e.not)(ac(t, e, r))) : s;
}
le.noPropertyInData = oc;
function Np(t) {
  return t ? Object.keys(t).filter((e) => e !== "__proto__") : [];
}
le.allSchemaProperties = Np;
function AE(t, e) {
  return Np(e).filter((r) => !(0, sc.alwaysValidSchema)(t, e[r]));
}
le.schemaProperties = AE;
...
le.callValidateCode = kE;
const LE = (0, $e._)`new RegExp`;
function DE({ gen: t, it: { opts: e } }, r) {
  const n = e.unicodeRegExp ? "u" : "", { regExp: s } = e.code, a = s(r, n);
  return t.scopeValue("pattern", {
    key: a.toString(),
    ref: a,
    code: (0, $e._)`${s.code === "new RegExp" ? LE : (0, OE.useFunc)(t, s)}(${r}, ${n})`
  });
}
le.usePattern = DE;
function ME(t) {
...
function VE(t) {
  ...
  if (!Array.isArray(r))
    throw new Error("ajv implementation error");
  if (r.some((c) => (0, sc.alwaysValidSchema)(s, c)) && !s.opts.unevaluated)
    return;
  const o = e.let("valid", !1), i = e.name("_valid");
  e.block(() => r.forEach((c, d) => {
    const l = t.subschema({
...
const Ke = ie, br = Et, FE = le, qE = ss;
function zE(t, e) {
  const { gen: r, keyword: n, schema: s, parentSchema: a, it: o } = t, i = e.macro.call(o.self, s, a, o), c = Pp(r, n, i);
  o.opts.validateSchema !== !1 && o.self.validateSchema(i, !0);
  const d = r.name("valid");
  t.subschema({
    schema: i,
...
St.macroKeywordCode = zE;
function UE(t, e) {
  var r;
  const { gen: n, keyword: s, schema: a, parentSchema: o, $data: i, it: c } = t;
  KE(c, e);
  const d = !i && e.compile ? e.compile.call(c.self, a, o, c) : e.validate, l = Pp(n, s, d), h = n.let("valid");
  t.block$data(h, _), t.ok((r = e.valid) !== null && r !== void 0 ? r : h);
  function _() {
    if (e.errors === !1)
      v(), e.modifying && Xl(t), g(() => t.error());
    else {
      const m = e.async ? $() : w();
      e.modifying && Xl(t), g(() => BE(t, m));
    }
  }
  function $() {
    const m = n.let("ruleErrs", null);
  ...
  function v(m = e.async ? (0, Ke._)`await ` : Ke.nil) {
    ...
    n.assign(h, (0, Ke._)`${m}${(0, FE.callValidateCode)(t, l, b, T)}`, e.modifying);
  }
  function g(m) {
    var b;
...
function BE(t, e) {
  ...
  r.if((0, Ke._)`Array.isArray(${e})`, () => {
    r.assign(br.default.vErrors, (0, Ke._)`${br.default.vErrors} === null ? ${e} : ${br.default.vErrors}.concat(${e})`).assign(br.default.errors, (0, Ke._)`${br.default.vErrors}.length`), (0, qE.extendErrors)(t);
  }, () => t.error());
}
function KE({ schemaEnv: t }, e) {
  if (e.async && !t.$async)
    throw new Error("async keyword in sync schema");
}
function Pp(t, e, r) {
...
St.validateKeywordUsage = GE;
var Zt = {};
Object.defineProperty(Zt, "__esModule", { value: !0 });
Zt.extendSubschemaMode = Zt.extendSubschemaData = Zt.getSubschema = void 0;
const wt = ie, Tp = z;
function xE(t, { keyword: e, schemaProp: r, schema: n, schemaPath: s, errSchemaPath: a, topSchemaRef: o }) {
  if (e !== void 0 && n !== void 0)
    throw new Error('both "keyword" and "schema" passed, only one allowed');
  if (e !== void 0) {
    const i = t.schema[e];
    return r === void 0 ? {
      ...
      errSchemaPath: `${t.errSchemaPath}/${e}/${(0, Tp.escapeFragment)(r)}`
    };
  }
  if (n !== void 0) {
    if (s === void 0 || a === void 0 || o === void 0)
...
function HE(t, e, { dataProp: r, dataPropType: n, data: s, dataTypes: a, propertyName: o }) {
  ...
  if (r !== void 0) {
    ...
    c(_), t.errorPath = (0, wt.str)`${d}${(0, Tp.getErrorPath)(r, n, h.jsPropertySyntax)}`, t.parentDataProperty = (0, wt._)`${r}`, t.dataPathArr = [...l, t.parentDataProperty];
  }
  if (s !== void 0) {
...
Zt.extendSubschemaData = HE;
function JE(t, { jtdDiscriminator: e, jtdMetadata: r, compositeRule: n, createErrors: s, allErrors: a }) {
  n !== void 0 && (t.compositeRule = n), s !== void 0 && (t.createErrors = s), a !== void 0 && (t.allErrors = a), t.jtdDiscriminator = e, t.jtdMetadata = r;
}
Zt.extendSubschemaMode = JE;
var Ce = {}, Op = { exports: {} }, Wt = Op.exports = function(t, e, r) {
  typeof e == "function" && (r = e, e = {}), r = e.cb || r;
  var n = typeof r == "function" ? r : r.pre || function() {
  }, s = r.post || function() {
  };
...
const YE = z, ZE = fa, e1 = XE, t1 = /* @__PURE__ */ new Set([
  "type",
  "format",
  "pattern",
  "maxLength",
...
function r1(t, e = !0) {
  return typeof t == "boolean" ? !0 : e === !0 ? !wo(t) : e ? Rp(t) <= e : !1;
}
Ce.inlineRef = r1;
...
function Rp(t) {
  ...
  for (const r in t) {
    if (r === "$ref")
      return 1 / 0;
    if (e++, !t1.has(r) && (typeof t[r] == "object" && (0, YE.eachItem)(t[r], (n) => e += Rp(n)), e === 1 / 0))
      return 1 / 0;
  }
  return e;
}
...
Ce.resolveUrl = a1;
const o1 = /^[a-z_][-a-z0-9._]*$/i;
function i1(t, e) {
  if (typeof t == "boolean")
    return {};
  const { schemaId: r, uriResolver: n } = this.opts, s = nn(t[r] || e), a = { "": s }, o = Ip(n, s, !1), i = {}, c = /* @__PURE__ */ new Set();
  return e1(t, { allKeys: !0 }, (h, _, $, w) => {
    if (w === void 0)
      return;
    const v = o + _;
    let g = a[w];
...
const Cp = un, Yl = Pe, ic = At, Ws = Pe, c1 = va, Un = St, Qa = Zt, J = ie, re = Et, l1 = Ce, kt = z, Rn = ss;
function u1(t) {
  if (Lp(t) && (Dp(t), kp(t))) {
    h1(t);
    return;
  }
  Ap(t, () => (0, Cp.topBoolOrEmptySchema)(t));
}
yt.validateFunctionCode = u1;
function Ap({ gen: t, validateName: e, schema: r, schemaEnv: n, opts: s }, a) {
  s.code.es5 ? t.func(e, (0, J._)`${re.default.data}, ${re.default.valCxt}`, n.$async, () => {
    t.code((0, J._)`"use strict"; ${Zl(r, s)}`), f1(t, s), t.code(a);
  }) : t.func(e, (0, J._)`${re.default.data}, ${d1(s)}`, n.$async, () => t.code(Zl(r, s)).code(a));
}
function d1(t) {
...
function h1(t) {
  const { schema: e, opts: r, gen: n } = t;
  Ap(t, () => {
    r.$comment && e.$comment && Vp(t), g1(t), n.let(re.default.vErrors, null), n.let(re.default.errors, 0), r.unevaluated && m1(t), Mp(t), w1(t);
  });
}
function m1(t) {
  const { gen: e, validateName: r } = t;
...
function p1(t, e) {
  ...
  (0, Cp.boolOrEmptySchema)(t, e);
}
function kp({ schema: t, self: e }) {
  if (typeof t == "boolean")
    return !t;
  for (const r in t)
    if (e.RULES.all[r])
...
function y1(t, e) {
  const { schema: r, gen: n, opts: s } = t;
  s.$comment && r.$comment && Vp(t), v1(t), _1(t);
  const a = n.const("_errs", re.default.errors);
  Mp(t, a), n.var(e, (0, J._)`${a} === ${re.default.errors}`);
}
function Dp(t) {
  (0, kt.checkUnknownRules)(t), $1(t);
}
function Mp(t, e) {
  if (t.opts.jtd)
    return eu(t, [], !1, e);
  const r = (0, Yl.getSchemaTypes)(t.schema), n = (0, Yl.coerceAndCheckDataType)(t, r);
  eu(t, r, !n, e);
}
function $1(t) {
  const { schema: e, errSchemaPath: r, opts: n, self: s } = t;
...
function v1(t) {
  const e = t.schema[t.opts.schemaId];
  e && (t.baseId = (0, l1.resolveUrl)(t.opts.uriResolver, t.baseId, e));
}
function _1(t) {
  if (t.schema.$async && !t.schemaEnv.$async)
    throw new Error("async schema in sync schema");
}
function Vp({ gen: t, schemaEnv: e, schema: r, errSchemaPath: n, opts: s }) {
  const a = r.$comment;
  if (s.$comment === !0)
...
function w1(t) {
  const { gen: e, schemaEnv: r, validateName: n, ValidationError: s, opts: a } = t;
  r.$async ? e.if((0, J._)`${re.default.errors} === 0`, () => e.return(re.default.data), () => e.throw((0, J._)`new ${s}(${re.default.vErrors})`)) : (e.assign((0, J._)`${n}.errors`, re.default.vErrors), a.unevaluated && b1(t), e.return((0, J._)`${re.default.errors} === 0`));
}
function b1({ gen: t, evaluated: e, props: r, items: n }) {
...
function eu(t, e, r, n) {
  ...
  if (a.$ref && (c.ignoreKeywordsWithRef || !(0, kt.schemaHasRulesButRef)(a, l))) {
    s.block(() => zp(t, "$ref", l.all.$ref.definition));
    return;
  }
  c.jtd || S1(t, e), s.block(() => {
    for (const _ of l.rules)
      h(_);
    h(l.post);
  });
  function h(_) {
    (0, ic.shouldUseGroup)(a, _) && (_.type ? (s.if((0, Ws.checkDataType)(_.type, o, c.strictNumbers)), tu(t, _), e.length === 1 && e[0] === _.type && r && (s.else(), (0, Ws.reportTypeError)(t)), s.endIf()) : tu(t, _), i || s.if((0, J._)`${re.default.errors} === ${n || 0}`));
  }
}
function tu(t, e) {
  const { gen: r, schema: n, opts: { useDefaults: s } } = t;
  s && (0, c1.assignDefaults)(t, e.type), r.block(() => {
    for (const a of e.rules)
      (0, ic.shouldUseRule)(n, a) && zp(t, a.keyword, a.definition, e.type);
  });
}
function S1(t, e) {
  t.schemaEnv.meta || !t.opts.strictTypes || (E1(t, e), t.opts.allowUnionTypes || N1(t, e), P1(t, t.dataTypes));
}
function E1(t, e) {
  if (e.length) {
    if (!t.dataTypes.length) {
    ...
    e.forEach((r) => {
      Fp(t.dataTypes, r) || cc(t, `type "${r}" not allowed by context "${t.dataTypes.join(",")}"`);
    }), O1(t, e);
  }
}
function N1(t, e) {
  e.length > 1 && !(e.length === 2 && e.includes("null")) && cc(t, "use allowUnionTypes to allow union type keyword");
}
function P1(t, e) {
  const r = t.self.RULES.all;
  for (const n in r) {
    const s = r[n];
    if (typeof s == "object" && (0, ic.shouldUseRule)(t.schema, s)) {
      const { type: a } = s.definition;
      a.length && !a.some((o) => T1(e, o)) && cc(t, `missing type "${a.join(",")}" for keyword "${n}"`);
    }
  }
}
function T1(t, e) {
...
function O1(t, e) {
  const r = [];
  for (const n of t.dataTypes)
    Fp(e, n) ? r.push(n) : e.includes("integer") && n === "number" && r.push("integer");
  t.dataTypes = r;
}
function cc(t, e) {
  const r = t.schemaEnv.baseId + t.errSchemaPath;
...
class qp {
  constructor(e, r, n) {
    if ((0, Un.validateKeywordUsage)(e, r, n), this.gen = e.gen, this.allErrors = e.allErrors, this.keyword = n, this.data = e.data, this.schema = e.schema[n], this.$data = r.$data && e.opts.$data && this.schema && this.schema.$data, this.schemaValue = (0, kt.schemaRefOrVal)(e, this.schema, n, this.$data), this.schemaType = r.schemaType, this.parentSchema = e.schema, this.params = {}, this.it = e, this.def = r, this.$data)
      this.schemaCode = e.gen.const("vSchema", Up(this.$data, e));
...
const R1 = /^\/(?:[^~]|~0|~1)*$/, I1 = /^([0-9]+)(#|\/(?:[^~]|~0|~1)*)?$/;
function Up(t, { dataLevel: e, dataNames: r, dataPathArr: n }) {
  let s, a;
  if (t === "")
...
const lt = ie, A1 = as, $r = Et, mt = Ce, ru = z, k1 = yt;
class _a {
  constructor(e) {
    var r;
    this.refs = {}, this.dynamicAnchors = {};
...
function lc(t) {
  ...
  let l;
  try {
    this._compilations.add(t), (0, k1.validateFunctionCode)(d), o.optimize(this.opts.code.optimize);
    const h = o.toString();
...
function L1(t, e, r) {
  ...
  if (s)
    return s;
  let a = V1.call(this, t, r);
  if (a === void 0) {
    const o = (n = t.localRefs) === null || n === void 0 ? void 0 : n[r], { schemaId: i } = this.opts;
    o && (a = new _a({ schema: o, schemaId: i, root: t, baseId: e }));
  }
  if (a !== void 0)
    return t.refs[r] = D1.call(this, a);
}
Xe.resolveRef = L1;
function D1(t) {
  return (0, mt.inlineRef)(t.schema, this.opts.inlineRefs) ? t.schema : t.validate ? t : lc.call(this, t);
}
function Bp(t) {
  for (const e of this._compilations)
    if (M1(e, t))
...
function wa(t, e) {
  ...
  if (typeof (o == null ? void 0 : o.schema) == "object") {
    if (o.validate || lc.call(this, o), a === (0, mt.normalizeId)(e)) {
      const { schema: i } = o, { schemaId: c } = this.opts, d = i[c];
...
function xa(t, { baseId: e, schema: r, root: n }) {
  ...
  for (const i of t.fragment.slice(1).split("/")) {
    if (typeof r == "boolean")
      return;
    const c = r[(0, ru.unescapeFragment)(i)];
    if (c === void 0)
      return;
    r = c;
    const d = typeof r == "object" && r[this.opts.schemaId];
    !F1.has(i) && d && (e = (0, mt.resolveUrl)(this.opts.uriResolver, e, d));
  }
  let a;
  if (typeof r != "boolean" && r.$ref && !(0, ru.schemaHasRulesButRef)(r, this.RULES)) {
...
const q1 = "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#", z1 = "Meta-schema for $data reference (JSON AnySchema extension proposal)", U1 = "object", B1 = [
  "$data"
], K1 = {
  $data: {
    type: "string",
  ...
  required: B1,
  properties: K1,
  additionalProperties: Q1
};
var uc = {};
Object.defineProperty(uc, "__esModule", { value: !0 });
const Kp = Zm;
Kp.code = 'require("ajv/dist/runtime/uri").default';
uc.default = Kp;
(function(t) {
  Object.defineProperty(t, "__esModule", { value: !0 }), t.CodeGen = t.Name = t.nil = t.stringify = t.str = t._ = t.KeywordCxt = void 0;
  var e = yt;
  ...
  const n = as, s = vn, a = Ir, o = Xe, i = ie, c = Ce, d = Pe, l = z, h = G1, _ = uc, $ = (P, p) => new RegExp(P, p);
  $.code = "new RegExp";
  const w = ["removeAdditional", "useDefaults", "coerceTypes"], v = /* @__PURE__ */ new Set([
    "validate",
    "serialize",
...
const H1 = vn, nu = le, Je = ie, Br = Et, su = Xe, $s = z, J1 = {
  keyword: "$ref",
  schemaType: "string",
  code(t) {
    const { gen: e, schema: r, it: n } = t, { baseId: s, schemaEnv: a, validateName: o, opts: i, self: c } = n, { root: d } = a;
    if ((r === "#" || r === "#/") && s === d.baseId)
      return h();
    const l = su.resolveRef.call(c, d, s, r);
    if (l === void 0)
      throw new H1.default(n.opts.uriResolver, s, r);
    if (l instanceof su.SchemaEnv)
      return _(l);
    return $(l);
    function h() {
      if (a === d)
...
function Vs(t, e, r, n) {
  ...
  function l() {
    ...
    const w = s.let("valid");
    s.try(() => {
      s.code((0, Je._)`await ${(0, nu.callValidateCode)(t, e, d)}`), $(e), o || s.assign(w, !0);
    }, (v) => {
      s.if((0, Je._)`!(${v} instanceof ${a.ValidationError})`, () => s.throw(v)), _(v), o || s.assign(w, !1);
    }), t.ok(w);
  }
  function h() {
    t.result((0, nu.callValidateCode)(t, e, d), () => $(e), () => _(e));
  }
  function _(w) {
...
gc.default = Gp;
Gp.code = 'require("ajv/dist/runtime/ucs2length").default';
Object.defineProperty($c, "__esModule", { value: !0 });
const Sr = ie, nN = z, sN = gc, aN = {
  message({ keyword: t, schemaCode: e }) {
    const r = t === "maxLength" ? "more" : "fewer";
  ...
  error: aN,
  code(t) {
    const { keyword: e, data: r, schemaCode: n, it: s } = t, a = e === "maxLength" ? Sr.operators.GT : Sr.operators.LT, o = s.opts.unicode === !1 ? (0, Sr._)`${r}.length` : (0, Sr._)`${(0, nN.useFunc)(t.gen, sN.default)}(${r})`;
...
const iN = le, cN = z, Yr = ie, lN = {
  ...
  code(t) {
    const { gen: e, data: r, $data: n, schema: s, schemaCode: a, it: o } = t, i = o.opts.unicodeRegExp ? "u" : "";
    if (n) {
      const { regExp: c } = o.opts.code, d = c.code === "new RegExp" ? (0, Yr._)`new RegExp` : (0, cN.useFunc)(e, c), l = e.let("valid");
      e.try(() => e.assign(l, (0, Yr._)`${d}(${a}, ${i}).test(${r})`), () => e.assign(l, !1)), t.fail$data((0, Yr._)`!${l}`);
    } else {
      const c = (0, iN.usePattern)(t, s);
  ...
  code(t) {
    ...
    if (o.allErrors ? d() : l(), i.strictRequired) {
      ...
      for (const v of r)
        if (($ == null ? void 0 : $[v]) === void 0 && !w.has(v)) {
          const g = o.schemaEnv.baseId + o.errSchemaPath, m = `required property "${v}" is not defined at "${g}" (strictRequired)`;
          (0, hN.checkStrictMode)(o, m, o.opts.strictRequired);
        }
    }
    function d() {
      if (c || a)
...
const xp = fa;
xp.code = 'require("ajv/dist/runtime/equal").default';
os.default = xp;
Object.defineProperty(Sc, "__esModule", { value: !0 });
const Ha = Pe, Ie = ie, gN = z, vN = os, _N = {
  ...
  code(t) {
    ...
    function $(w, v) {
      const g = (0, gN.useFunc)(e, vN.default), m = e.name("outer");
...
const bo = ie, bN = z, SN = os, EN = {
  ...
  code(t) {
    const { gen: e, data: r, $data: n, schemaCode: s, schema: a } = t;
    n || a && typeof a == "object" ? t.fail$data((0, bo._)`!${(0, bN.useFunc)(e, SN.default)}(${r}, ${s})`) : t.fail((0, bo._)`${a} !== ${r}`);
  }
};
Ec.default = NN;
var Nc = {};
Object.defineProperty(Nc, "__esModule", { value: !0 });
const kn = ie, PN = z, TN = os, ON = {
  message: "must be equal to one of the allowed values",
  ...
  code(t) {
    ...
    const i = s.length >= o.opts.loopEnum;
    let c;
    const d = () => c ?? (c = (0, PN.useFunc)(e, TN.default));
    let l;
    if (i || n)
      l = e.let("valid"), t.block$data(l, h);
    else {
...
const IN = pc, jN = yc, CN = $c, AN = vc, kN = _c, LN = wc, DN = bc, MN = Sc, VN = Ec, FN = Nc, qN = [
  // number
  IN.default,
  jN.default,
  // string
...
_n.validateAdditionalItems = Hp;
_n.default = UN;
var Tc = {}, wn = {};
Object.defineProperty(wn, "__esModule", { value: !0 });
wn.validateTuple = void 0;
const au = ie, Fs = z, BN = le, KN = {
  keyword: "items",
  type: "array",
  schemaType: ["object", "array", "boolean"],
  before: "uniqueItems",
  code(t) {
    const { schema: e, it: r } = t;
    if (Array.isArray(e))
      return Jp(t, "additionalItems", e);
    r.items = !0, !(0, Fs.alwaysValidSchema)(r, e) && t.ok((0, BN.validateArray)(t));
  }
};
function Jp(t, e, r = t.schema) {
  const { gen: n, parentSchema: s, data: a, keyword: o, it: i } = t;
  l(s), i.opts.unevaluated && r.length && i.items !== !0 && (i.items = Fs.mergeEvaluated.items(n, r.length, i.items));
  const c = n.name("valid"), d = n.const("len", (0, au._)`${a}.length`);
  r.forEach((h, _) => {
    (0, Fs.alwaysValidSchema)(i, h) || (n.if((0, au._)`${d} > ${_}`, () => t.subschema({
      keyword: o,
      schemaProp: _,
      dataProp: _
    }, c)), t.ok(c));
...
const QN = wn, GN = {
  ...
  schemaType: ["array"],
  before: "uniqueItems",
  code: (t) => (0, QN.validateTuple)(t, "items")
};
Tc.default = GN;
var Oc = {};
Object.defineProperty(Oc, "__esModule", { value: !0 });
const ou = ie, xN = z, HN = le, JN = _n, WN = {
  ...
  code(t) {
    const { schema: e, parentSchema: r, it: n } = t, { prefixItems: s } = r;
    n.items = !0, !(0, xN.alwaysValidSchema)(n, e) && (s ? (0, JN.validateAdditionalItems)(t, s) : t.ok((0, HN.validateArray)(t)));
  }
};
Oc.default = XN;
var Rc = {};
...
const Xp = ie, eP = z, tP = {
  message: "property name must be valid",
  params: ({ params: t }) => (0, Xp._)`{propertyName: ${t.propertyName}}`
}, rP = {
  keyword: "propertyNames",
  type: "object",
  schemaType: ["object", "boolean"],
...
const vs = le, dt = ie, nP = Et, _s = z, sP = {
  message: "must NOT have additional properties",
  ...
  code(t) {
    ...
    h(), t.ok((0, dt._)`${a} === ${nP.default.errors}`);
    function h() {
      e.forIn("key", s, (g) => {
        !d.length && !l.length ? w(g) : e.if(_(g), () => w(g));
      });
...
const oP = yt, iu = le, Ja = z, cu = ba, iP = {
  keyword: "properties",
  type: "object",
  schemaType: "object",
  code(t) {
    const { gen: e, schema: r, parentSchema: n, data: s, it: a } = t;
    a.opts.removeAdditional === "all" && n.additionalProperties === void 0 && cu.default.code(new oP.KeywordCxt(a, cu.default, "additionalProperties"));
    const o = (0, iu.allSchemaProperties)(r);
    for (const h of o)
      a.definedProperties.add(h);
    ...
    const c = e.name("valid");
    for (const h of i)
      d(h) ? l(h) : (e.if((0, iu.propertyInData)(e, s, h, a.opts.ownProperties)), l(h), a.allErrors || e.else().var(c, !0), e.endIf()), t.it.definedProperties.add(h), t.ok(c);
    function d(h) {
      return a.opts.useDefaults && !a.compositeRule && r[h].default !== void 0;
    }
    function l(h) {
...
const lu = le, ws = ie, uu = z, du = z, cP = {
  keyword: "patternProperties",
  type: "object",
  schemaType: "object",
  code(t) {
    const { gen: e, schema: r, data: n, parentSchema: s, it: a } = t, { opts: o } = a, i = (0, lu.allSchemaProperties)(r), c = i.filter((v) => (0, uu.alwaysValidSchema)(a, r[v]));
    if (i.length === 0 || c.length === i.length && (!a.opts.unevaluated || a.props === !0))
      return;
    const d = o.strictSchema && !o.allowMatchingProperties && s.properties, l = e.name("valid");
    a.props !== !0 && !(a.props instanceof ws.Name) && (a.props = (0, du.evaluatedPropsToName)(e, a.props));
    const { props: h } = a;
    _();
    function _() {
      for (const v of i)
    ...
    function $(v) {
      for (const g in d)
        new RegExp(v).test(g) && (0, uu.checkStrictMode)(a, `property ${g} matches pattern ${v} (use allowMatchingProperties)`);
    }
    function w(v) {
      e.forIn("key", n, (g) => {
        e.if((0, ws._)`${(0, lu.usePattern)(t, v)}.test(${g})`, () => {
          const m = c.includes(v);
          m || t.subschema({
            keyword: "patternProperties",
            schemaProp: v,
            dataProp: g,
            dataPropType: du.Type.Str
...
const qs = ie, hP = z, mP = {
  ...
  code(t) {
    ...
    function d() {
      a.forEach((l, h) => {
        let _;
        (0, hP.alwaysValidSchema)(s, l) ? e.var(c, !0) : _ = t.subschema({
          keyword: "oneOf",
          schemaProp: h,
          compositeRule: !0
...
const Zs = ie, Yp = z, gP = {
  ...
  code(t) {
    const { gen: e, parentSchema: r, it: n } = t;
    r.then === void 0 && r.else === void 0 && (0, Yp.checkStrictMode)(n, '"if" without "then" and "else" is ignored');
    const s = fu(n, "then"), a = fu(n, "else");
    if (!s && !a)
      return;
    const o = e.let("valid", !0), i = e.name("_valid");
    if (c(), t.reset(), s && a) {
...
function fu(t, e) {
  const r = t.schema[e];
  return r !== void 0 && !(0, Yp.alwaysValidSchema)(t, r);
}
Mc.default = vP;
var Vc = {};
Object.defineProperty(Vc, "__esModule", { value: !0 });
const _P = z, wP = {
  ...
  schemaType: ["object", "boolean"],
  code({ keyword: t, parentSchema: e, it: r }) {
    e.if === void 0 && (0, _P.checkStrictMode)(r, `"${t}" without "if" is ignored`);
  }
};
Vc.default = wP;
Object.defineProperty(Pc, "__esModule", { value: !0 });
const bP = _n, SP = Tc, EP = wn, NP = Oc, PP = Rc, TP = Wp, OP = Ic, RP = ba, IP = jc, jP = Cc, CP = Ac, AP = kc, kP = Lc, LP = Dc, DP = Mc, MP = Vc;
function VP(t = !1) {
  const e = [
    // any
    CP.default,
  ...
  return t ? e.push(SP.default, NP.default) : e.push(bP.default, EP.default), e.push(PP.default), e;
}
Pc.default = VP;
var Fc = {}, qc = {};
...
Object.defineProperty(dc, "__esModule", { value: !0 });
const BP = fc, KP = mc, QP = Pc, GP = Fc, hu = dn, xP = [
  BP.default,
  KP.default,
  (0, QP.default)(),
  GP.default,
  hu.metadataVocabulary,
  hu.contentVocabulary
];
dc.default = xP;
var zc = {}, Sa = {};
...
const xr = ie, Eo = Sa, pu = Xe, HP = vn, JP = z, WP = {
  ...
  code(t) {
    ...
    function _() {
      ...
      for (let O = 0; O < o.length; O++) {
        let I = o[O];
        if (I != null && I.$ref && !(0, JP.schemaHasRulesButRef)(I, a.self.RULES)) {
          const D = I.$ref;
          if (I = pu.resolveRef.call(a.self, a.schemaEnv.root, a.baseId, D), I instanceof pu.SchemaEnv && (I = I.schema), I === void 0)
            throw new HP.default(a.opts.uriResolver, a.baseId, D);
        }
        const q = ($ = I == null ? void 0 : I.properties) === null || $ === void 0 ? void 0 : $[i];
        if (typeof q != "object")
          throw new Error(`discriminator: oneOf subschemas (or referenced schemas) must have "properties/${i}"`);
...
zc.default = XP;
const YP = "http://json-schema.org/draft-07/schema#", ZP = "http://json-schema.org/draft-07/schema#", eT = "Core schema meta-schema", tT = {
  schemaArray: {
    type: "array",
    minItems: 1,
    items: {
...
(function(t, e) {
  ...
  const r = fp, n = dc, s = zc, a = sT, o = ["/properties"], i = "http://json-schema.org/draft-07/schema";
...
(function(t) {
  ...
  const e = aT, r = ie, n = r.operators, s = {
...
(function(t, e) {
  ...
  const r = up, n = dp, s = ie, a = new s.Name("fullFormats"), o = new s.Name("fastFormats"), i = (d, l = { keywords: !0 }) => {
    if (Array.isArray(l))
...
${e}`, fT = Object.getOwnPropertyDescriptor(Function.prototype, "toString"), hT = Object.getOwnPropertyDescriptor(Function.prototype.toString, "name"), mT = (t, e, r) => {
  const n = r === "" ? "" : `with ${r.trim()}() `, s = dT.bind(null, n, e.toString());
  Object.defineProperty(s, "name", hT);
  const { writable: a, enumerable: o, configurable: i } = fT;
  Object.defineProperty(t, "toString", { value: s, writable: a, enumerable: o, configurable: i });
};
function pT(t, e, { ignoreNonConfigurable: r = !1 } = {}) {
  const { name: n } = t;
  for (const s of Reflect.ownKeys(e))
    cT(t, e, s, r);
  return uT(t, e), mT(t, e, n), t;
}
const yu = (t, e = {}) => {
  ...
  return pT(d, t), d.cancel = () => {
    o && (clearTimeout(o), o = void 0), i && (clearTimeout(i), i = void 0);
  }, d;
};
var No = { exports: {} };
const yT = "2.0.0", Zp = 256, $T = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, gT = 16, vT = Zp - 6, _T = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
var is = {
  ...
  MAX_SAFE_BUILD_LENGTH: vT,
  MAX_SAFE_INTEGER: $T,
  RELEASE_TYPES: _T,
  SEMVER_SPEC_VERSION: yT,
  FLAG_INCLUDE_PRERELEASE: 1,
  FLAG_LOOSE: 2
};
const wT = typeof process == "object" && process.env && process.env.NODE_DEBUG && /\bsemver\b/i.test(process.env.NODE_DEBUG) ? (...t) => console.error("SEMVER", ...t) : () => {
};
var Ea = wT;
(function(t, e) {
  const {
...
var cs = No.exports;
const bT = Object.freeze({ loose: !0 }), ST = Object.freeze({}), ET = (t) => t ? typeof t != "object" ? bT : t : ST;
var Uc = ET;
const $u = /^[0-9]+$/, ey = (t, e) => {
  if (typeof t == "number" && typeof e == "number")
    return t === e ? 0 : t < e ? -1 : 1;
  const r = $u.test(t), n = $u.test(e);
...
const bs = Ea, { MAX_LENGTH: gu, MAX_SAFE_INTEGER: Ss } = is, { safeRe: Es, t: Ns } = cs, PT = Uc, { compareIdentifiers: Po } = ty, TT = (t, e) => {
  const r = e.split(".");
...
let OT = class vt {
  constructor(e, r) {
    ...
    if (e.length > gu)
      throw new TypeError(
        `version is longer than ${gu} characters`
      );
  ...
  inc(e, r, n) {
    ...
    switch (e) {
      ...
      case "pre": {
        ...
        if (r) {
          let a = [r, s];
          if (n === !1 && (a = [r]), TT(this.prerelease, r)) {
...
var CT = jT;
const AT = Mr, kT = (t, e) => {
  const r = AT(t.trim().replace(/^[=v]+/, ""), e);
  return r ? r.version : null;
};
var LT = kT;
const _u = Ue, DT = (t, e, r, n, s) => {
  typeof r == "string" && (s = n, n = r, r = void 0);
  try {
    return new _u(
      t instanceof _u ? t.version : t,
      r
    ).inc(e, n, s).version;
  } catch {
    return null;
...
var MT = DT;
const wu = Mr, VT = (t, e) => {
  const r = wu(t, null, !0), n = wu(e, null, !0), s = r.compare(n);
  if (s === 0)
    return null;
...
var FT = VT;
const qT = Ue, zT = (t, e) => new qT(t, e).major;
var UT = zT;
const BT = Ue, KT = (t, e) => new BT(t, e).minor;
var QT = KT;
const GT = Ue, xT = (t, e) => new GT(t, e).patch;
var HT = xT;
const JT = Mr, WT = (t, e) => {
  const r = JT(t, e);
...
var XT = WT;
const bu = Ue, YT = (t, e, r) => new bu(t, r).compare(new bu(e, r));
var $t = YT;
const ZT = $t, eO = (t, e, r) => ZT(e, t, r);
var tO = eO;
const rO = $t, nO = (t, e) => rO(t, e, !0);
var sO = nO;
const Su = Ue, aO = (t, e, r) => {
  const n = new Su(t, r), s = new Su(e, r);
  return n.compare(s) || n.compareBuild(s);
};
var Bc = aO;
const oO = Bc, iO = (t, e) => t.sort((r, n) => oO(r, n, e));
var cO = iO;
const lO = Bc, uO = (t, e) => t.sort((r, n) => lO(n, r, e));
var dO = uO;
const fO = $t, hO = (t, e, r) => fO(t, e, r) > 0;
var Na = hO;
const mO = $t, pO = (t, e, r) => mO(t, e, r) < 0;
var Kc = pO;
const yO = $t, $O = (t, e, r) => yO(t, e, r) === 0;
var ry = $O;
const gO = $t, vO = (t, e, r) => gO(t, e, r) !== 0;
var ny = vO;
const _O = $t, wO = (t, e, r) => _O(t, e, r) >= 0;
var Qc = wO;
const bO = $t, SO = (t, e, r) => bO(t, e, r) <= 0;
var Gc = SO;
const EO = ry, NO = ny, PO = Na, TO = Qc, OO = Kc, RO = Gc, IO = (t, e, r, n) => {
  switch (e) {
    case "===":
...
var sy = IO;
const jO = Ue, CO = Mr, { safeRe: Ps, t: Ts } = cs, AO = (t, e) => {
  if (t instanceof jO)
    return t;
  ...
  return CO(`${n}.${s}.${a}${o}${i}`, e);
};
var kO = AO;
const LO = Mr, DO = is, MO = Ue, VO = (t, e, r) => {
  if (!DO.RELEASE_TYPES.includes(e))
    return null;
  const n = FO(t, r);
  return n && qO(n, e);
}, FO = (t, e) => {
  const r = t instanceof MO ? t.version : t;
  return LO(r, e);
}, qO = (t, e) => {
  if (zO(e))
    return t.version;
...
function gt() {
  ...
  Wa = e;
  const r = KO, n = new r(), s = Uc, a = Pa(), o = Ea, i = Ue, {
    safeRe: c,
    src: d,
    t: l,
...
function Pa() {
  ...
  Xa = e;
  const r = Uc, { safeRe: n, t: s } = cs, a = sy, o = Ea, i = Ue, c = gt();
  return Xa;
}
const QO = gt(), GO = (t, e, r) => {
  try {
    e = new QO(e, r);
  } catch {
    return !1;
...
var Ta = GO;
const xO = gt(), HO = (t, e) => new xO(t, e).set.map((r) => r.map((n) => n.value).join(" ").trim().split(" "));
var JO = HO;
const WO = Ue, XO = gt(), YO = (t, e, r) => {
  ...
  return t.forEach((o) => {
    a.test(o) && (!n || s.compare(o) === -1) && (n = o, s = new WO(n, r));
  }), n;
};
var ZO = YO;
const eR = Ue, tR = gt(), rR = (t, e, r) => {
  let n = null, s = null, a = null;
  try {
    a = new tR(e, r);
  } catch {
  ...
  return t.forEach((o) => {
    a.test(o) && (!n || s.compare(o) === 1) && (n = o, s = new eR(n, r));
  }), n;
};
var nR = rR;
const Ya = Ue, sR = gt(), Pu = Na, aR = (t, e) => {
  t = new sR(t, e);
  let r = new Ya("0.0.0");
...
const iR = gt(), cR = (t, e) => {
  try {
    return new iR(t, e).range || "*";
  } catch {
    return null;
  }
};
var lR = cR;
const uR = Ue, ay = Pa(), { ANY: dR } = ay, fR = gt(), hR = Ta, Tu = Na, Ou = Kc, mR = Gc, pR = Qc, yR = (t, e, r, n) => {
  t = new uR(t, n), e = new fR(e, n);
  let s, a, o, i, c;
  switch (r) {
    case ">":
      s = Tu, a = mR, o = Ou, i = ">", c = ">=";
  ...
  for (let d = 0; d < e.set.length; ++d) {
    ...
    let h = null, _ = null;
    if (l.forEach(($) => {
      $.semver === dR && ($ = new ay(">=0.0.0")), h = h || $, _ = _ || $, s($.semver, h.semver, n) ? h = $ : o($.semver, _.semver, n) && (_ = $);
...
var xc = yR;
const $R = xc, gR = (t, e, r) => $R(t, e, ">", r);
var vR = gR;
const _R = xc, wR = (t, e, r) => _R(t, e, "<", r);
var bR = wR;
const Ru = gt(), SR = (t, e, r) => (t = new Ru(t, r), e = new Ru(e, r), t.intersects(e, r));
var ER = SR;
const NR = Ta, PR = $t;
var TR = (t, e, r) => {
  const n = [];
  let s = null, a = null;
  const o = t.sort((l, h) => PR(l, h, r));
  for (const l of o)
    NR(l, e, r) ? (a = l, s || (s = l)) : (a && n.push([s, a]), a = null, s = null);
  s && n.push([s, null]);
  const i = [];
  for (const [l, h] of n)
...
const Iu = gt(), Hc = Pa(), { ANY: Za } = Hc, eo = Ta, Jc = $t, OR = (t, e, r = {}) => {
  if (t === e)
    return !0;
  t = new Iu(t, r), e = new Iu(e, r);
  let n = !1;
  ...
  return !0;
}, RR = [new Hc(">=0.0.0-0")], ju = [new Hc(">=0.0.0")], IR = (t, e, r) => {
  if (t === e)
    return !0;
  if (t.length === 1 && t[0].semver === Za) {
    if (e.length === 1 && e[0].semver === Za)
      return !0;
    r.includePrerelease ? t = RR : t = ju;
  }
  if (e.length === 1 && e[0].semver === Za) {
  ...
  let s, a;
  for (const $ of t)
    $.operator === ">" || $.operator === ">=" ? s = Cu(s, $, r) : $.operator === "<" || $.operator === "<=" ? a = Au(a, $, r) : n.add($.semver);
  if (n.size > 1)
    return null;
  let o;
  if (s && a) {
    if (o = Jc(s.semver, a.semver, r), o > 0)
      return null;
  ...
  if (!t)
    return e;
  const n = Jc(t.semver, e.semver, r);
...
var jR = OR;
const to = cs, ku = is, CR = Ue, Lu = ty, AR = Mr, kR = CT, LR = LT, DR = MT, MR = FT, VR = UT, FR = QT, qR = HT, zR = XT, UR = $t, BR = tO, KR = sO, QR = Bc, GR = cO, xR = dO, HR = Na, JR = Kc, WR = ry, XR = ny, YR = Qc, ZR = Gc, eI = sy, tI = kO, rI = UO, nI = Pa(), sI = gt(), aI = Ta, oI = JO, iI = ZO, cI = nR, lI = oR, uI = lR, dI = xc, fI = vR, hI = bR, mI = ER, pI = TR, yI = jR;
var $I = {
  parse: AR,
  valid: kR,
  clean: LR,
  ...
  compareIdentifiers: Lu.compareIdentifiers,
  rcompareIdentifiers: Lu.rcompareIdentifiers
};
const Kr = /* @__PURE__ */ om($I), gI = Object.prototype.toString, vI = "[object Uint8Array]", _I = "[object ArrayBuffer]";
function oy(t, e, r) {
  return t ? t.constructor === e ? !0 : gI.call(t) === r : !1;
}
function iy(t) {
  return oy(t, Uint8Array, vI);
}
function wI(t) {
  return oy(t, ArrayBuffer, _I);
}
function bI(t) {
  return iy(t) || wI(t);
}
...
function Du(t, e) {
  ...
  let n = 0;
  for (const s of t)
    SI(s), r.set(s, n), n += s.length;
  return r;
}
const Os = {
  utf8: new globalThis.TextDecoder("utf8")
};
function Mu(t, e = "utf8") {
  return EI(t), Os[e] ?? (Os[e] = new globalThis.TextDecoder(e)), Os[e].decode(t);
}
function NI(t) {
  if (typeof t != "string")
    throw new TypeError(`Expected \`string\`, got \`${typeof t}\``);
}
const PI = new globalThis.TextEncoder();
function ro(t) {
  return NI(t), PI.encode(t);
}
Array.from({ length: 256 }, (t, e) => e.toString(16).padStart(2, "0"));
const TI = iT.default, Vu = "aes-256-cbc", Qr = () => /* @__PURE__ */ Object.create(null), OI = (t) => t != null, RI = (t, e) => {
...
class II {
  ...
  set(e, r) {
    ...
    const { store: n } = this, s = (a, o) => {
      RI(a, o), ve(this, tt).accessPropertiesByDotNotation ? ml(n, a, o) : n[a] = o;
    };
    if (typeof e == "object") {
      const a = e;
  ...
  has(e) {
    return ve(this, tt).accessPropertiesByDotNotation ? R$(this.store, e) : e in this.store;
  }
  /**
  ...
  reset(...e) {
    for (const r of e)
      OI(ve(this, Ot)[r]) && this.set(r, ve(this, Ot)[r]);
  }
  delete(e) {
    const { store: r } = this;
    ve(this, tt).accessPropertiesByDotNotation ? O$(r, e) : delete r[e], this.store = r;
  }
  /**
      Delete all items.
  ...
  *[Symbol.iterator]() {
  ...
  _encryptData(e) {
    if (!ve(this, Tt))
      return typeof e == "string" ? e : Mu(e);
    try {
      const r = e.slice(0, 16), n = Pn.pbkdf2Sync(ve(this, Tt), r.toString(), 1e4, 32, "sha512"), s = Pn.createDecipheriv(Vu, n, r), a = e.slice(17), o = typeof a == "string" ? ro(a) : a;
      return Mu(Du([s.update(o), s.final()]));
    } catch {
    }
    return e.toString();
  }
  ...
  _ensureDirectory() {
    Z.mkdirSync(X.dirname(this.path), { recursive: !0 });
  }
  _write(e) {
    let r = this._serialize(e);
    if (ve(this, Tt)) {
      const n = Pn.randomBytes(16), s = Pn.pbkdf2Sync(ve(this, Tt), n.toString(), 1e4, 32, "sha512"), a = Pn.createCipheriv(Vu, s, n);
      r = Du([n, ro(":"), a.update(ro(r)), a.final()]);
    }
    if (_e.env.SNAP)
      Z.writeFileSync(this.path, r, { mode: ve(this, tt).configFileMode });
    else
      try {
        am(this.path, r, { mode: ve(this, tt).configFileMode });
      } catch (n) {
  ...
  _watch() {
    this._ensureDirectory(), Z.existsSync(this.path) || this._write(Qr()), _e.platform === "win32" ? Z.watch(this.path, { persistent: !1 }, yu(() => {
      this.events.dispatchEvent(new Event("change"));
    }, { wait: 100 })) : Z.watchFile(this.path, { persistent: !1 }, yu(() => {
      this.events.dispatchEvent(new Event("change"));
    }, { wait: 5e3 }));
  }
  _migrate(e, r, n) {
...
const qu = () => {
  ...
  return Fu || (To.on("electron-store-get-data", (e) => {
    e.returnValue = t;
  }), Fu = !0), t;
};
class CI extends II {
  constructor(e) {
    let r, n;
    if (_e.type === "renderer") {
      const s = em.ipcRenderer.sendSync("electron-store-get-data");
      if (!s)
        throw new Error("Electron Store: You need to call `.initRenderer()` from the main process.");
      ({ defaultCwd: r, appVersion: n } = s);
    } else To && Us && ({ defaultCwd: r, appVersion: n } = qu());
    e = {
      name: "config",
      ...e
  ...
  async openInEditor() {
    const e = await jI.openPath(this.path);
    if (e)
      throw new Error(e);
  }
}
...
N(cy, Xu, "ColumnBuilder");
const er = Symbol.for("drizzle:Name"), zu = Symbol.for("drizzle:isPgEnum");
function AI(t) {
  return !!t && typeof t == "function" && zu in t && t[zu] === !0;
}
var Yu;
Yu = k;
class ze {
...
N(ze, Yu, "Subquery");
var Zu, ed;
class Wc extends (ed = ze, Zu = k, ed) {
}
N(Wc, Zu, "WithSubquery");
const kI = {
  startActiveSpan(t, e) {
    return e();
  }
}, qe = Symbol.for("drizzle:ViewBaseConfig"), Bs = Symbol.for("drizzle:Schema"), Oo = Symbol.for("drizzle:Columns"), Uu = Symbol.for("drizzle:ExtraConfigColumns"), so = Symbol.for("drizzle:OriginalName"), ao = Symbol.for("drizzle:BaseName"), ea = Symbol.for("drizzle:IsAlias"), Bu = Symbol.for("drizzle:ExtraConfigBuilder"), LI = Symbol.for("drizzle:IsDrizzleTable");
var td, rd, nd, sd, ad, od, id, cd, ld, ud;
ud = k, ld = er, cd = so, id = Bs, od = Oo, ad = Uu, sd = ao, nd = ea, rd = LI, td = Bu;
class F {
  constructor(e, r, n) {
    /**
     * @internal
...
N(F, ud, "Table"), /** @internal */
N(F, "Symbol", {
  Name: er,
  Schema: Bs,
  OriginalName: so,
  Columns: Oo,
  ExtraConfigColumns: Uu,
  BaseName: ao,
  IsAlias: ea,
  ExtraConfigBuilder: Bu
});
function Zr(t) {
  return t[er];
}
...
const Nr = class Nr {
  ...
  toQuery(e) {
    return kI.startActiveSpan("drizzle.buildSQL", (r) => {
  ...
  buildQueryFromSourceParams(e, r) {
    ...
    return DI(e.map((l) => {
      ...
      return A(l, Cr) ? { sql: o(d.value++, l), params: [l], typings: ["none"] } : A(l, Nr.Aliased) && l.fieldAlias !== void 0 ? { sql: a(l.fieldAlias), params: [] } : A(l, ze) ? l._.isWith ? { sql: a(l._.alias), params: [] } : this.buildQueryFromSourceParams([
        ...
        new Oe(") "),
        new ta(l._.alias)
      ], n) : AI(l) ? l.schema ? { sql: a(l.schema) + "." + a(l.enumName), params: [] } : { sql: a(l.enumName), params: [] } : ly(l) ? (h = l.shouldOmitSQLParens) != null && h.call(l) ? this.buildQueryFromSourceParams([l.getSQL()], n) : this.buildQueryFromSourceParams([
        new Oe("("),
        l.getSQL(),
        new Oe(")")
...
const VI = Symbol.for("drizzle:IsDrizzleView");
var yd, $d, gd;
gd = k, $d = qe, yd = VI;
class Vr {
...
N(Xn, vd, "ColumnAliasProxyHandler");
var _d;
_d = k;
class Oa {
  constructor(e, r) {
...
N(Oa, _d, "TableAliasProxyHandler");
function oo(t, e) {
...
function ra(t, e) {
  return R.join(t.queryChunks.map((r) => A(r, Se) ? Pt(r, e) : A(r, W) ? ra(r, e) : A(r, W.Aliased) ? fy(r, e) : r));
}
var wd, bd;
class Ra extends (bd = Error, wd = k, bd) {
  constructor({ message: e, cause: r }) {
    super(e), this.name = "DrizzleError", this.cause = r;
  }
}
N(Ra, wd, "DrizzleError");
...
var Sd, Ed;
class hy extends (Ed = Ra, Sd = k, Ed) {
  constructor() {
    super({ message: "Rollback" });
  }
}
N(hy, Sd, "TransactionRollbackError");
var Nd;
Nd = k;
class my {
  write(e) {
...
N(my, Nd, "ConsoleLogWriter");
var Pd;
Pd = k;
class py {
  constructor(e) {
    N(this, "writer");
    this.writer = (e == null ? void 0 : e.writer) ?? new my();
  }
  logQuery(e, r) {
    const n = r.map((a) => {
      try {
...
N(yy, Td, "NoopLogger");
var Od, Rd;
Rd = k, Od = Symbol.toStringTag;
class tr {
  constructor() {
    N(this, Od, "QueryPromise");
  }
  catch(e) {
...
const gy = typeof TextDecoder > "u" ? null : new TextDecoder(), Qu = Symbol.for("drizzle:PgInlineForeignKeys"), Gu = Symbol.for("drizzle:EnableRLS");
var Id, jd, Cd, Ad, kd, Ld;
class Io extends (Ld = F, kd = k, Ad = Qu, Cd = Gu, jd = F.Symbol.ExtraConfigBuilder, Id = F.Symbol.ExtraConfigColumns, Ld) {
  constructor() {
    super(...arguments);
    /**@internal */
    N(this, Ad, []);
...
N(Io, kd, "PgTable"), /** @internal */
N(Io, "Symbol", Object.assign({}, F.Symbol, {
  InlineForeignKeys: Qu,
  EnableRLS: Gu
}));
var Dd;
Dd = k;
class vy {
  ...
  /** @internal */
  build(e) {
    return new _y(e, this.columns, this.name);
  }
}
N(vy, Dd, "PgPrimaryKeyBuilder");
var Md;
Md = k;
class _y {
  constructor(e, r, n) {
...
N(_y, Md, "PgPrimaryKey");
function Ye(t, e) {
  return MI(e) && !ly(t) && !A(t, Mt) && !A(t, Cr) && !A(t, Se) && !A(t, F) && !A(t, Vr) ? new Mt(t, e) : t;
}
const us = (t, e) => R`${t} = ${Ye(e, t)}`, UI = (t, e) => R`${t} <> ${Ye(e, t)}`;
function jo(...t) {
  const e = t.filter(
    (r) => r !== void 0
  );
...
const QI = (t, e) => R`${t} > ${Ye(e, t)}`, GI = (t, e) => R`${t} >= ${Ye(e, t)}`, xI = (t, e) => R`${t} < ${Ye(e, t)}`, HI = (t, e) => R`${t} <= ${Ye(e, t)}`;
function JI(t, e) {
...
N(wy, Fd, "Relations");
var qd, zd;
const oa = class oa extends (zd = Yc, qd = k, zd) {
  constructor(e, r, n, s) {
...
let kr = oa;
var Ud, Bd;
const ia = class ia extends (Bd = Yc, Ud = k, Bd) {
  constructor(e, r, n) {
    ...
    if (A(i, F)) {
      ...
      if (l)
        for (const h of Object.values(l))
          A(h, vy) && s[o].primaryKey.push(...h.columns);
    } else if (A(i, wy)) {
...
N(by, Qd, "SQLiteForeignKeyBuilder");
var Gd;
Gd = k;
class Sy {
  constructor(e, r) {
...
N(Sy, Gd, "SQLiteForeignKey");
function yj(t, e) {
  return `${t[er]}_${e.join("_")}_unique`;
}
var xd, Hd;
class ot extends (Hd = cy, xd = k, Hd) {
  constructor() {
    super(...arguments);
...
N(ot, xd, "SQLiteColumnBuilder");
var Jd, Wd;
class xe extends (Wd = Se, Jd = k, Wd) {
  constructor(e, r) {
    r.uniqueName || (r.uniqueName = yj(e, [r.name])), super(e, r), this.table = e;
  }
}
N(xe, Jd, "SQLiteColumn");
var Xd, Yd;
class Ey extends (Yd = ot, Xd = k, Yd) {
  constructor(e) {
...
N(Ey, Xd, "SQLiteBigIntBuilder");
var Zd, ef;
class Ny extends (ef = xe, Zd = k, ef) {
  getSQLType() {
    return "blob";
  }
  mapFromDriverValue(e) {
    ...
    return BigInt(gy.decode(e));
  }
  mapToDriverValue(e) {
    return Buffer.from(e.toString());
  }
}
N(Ny, Zd, "SQLiteBigInt");
var tf, rf;
class Py extends (rf = ot, tf = k, rf) {
  constructor(e) {
...
N(Py, tf, "SQLiteBlobJsonBuilder");
var nf, sf;
class Ty extends (sf = xe, nf = k, sf) {
  getSQLType() {
    return "blob";
  }
  mapFromDriverValue(e) {
    ...
    return JSON.parse(gy.decode(e));
  }
  mapToDriverValue(e) {
    return Buffer.from(JSON.stringify(e));
  }
}
N(Ty, nf, "SQLiteBlobJson");
var af, of;
class Oy extends (of = ot, af = k, of) {
  constructor(e) {
...
N(Oy, af, "SQLiteBlobBufferBuilder");
var cf, lf;
class Ry extends (lf = xe, cf = k, lf) {
  mapFromDriverValue(e) {
...
N(Ry, cf, "SQLiteBlobBuffer");
function $j(t, e) {
  const { name: r, config: n } = ls(t, e);
  return (n == null ? void 0 : n.mode) === "json" ? new Py(r) : (n == null ? void 0 : n.mode) === "bigint" ? new Ey(r) : new Oy(r);
}
var uf, df;
class Iy extends (df = ot, uf = k, df) {
  constructor(e, r, n) {
...
N(Iy, uf, "SQLiteCustomColumnBuilder");
var ff, hf;
class jy extends (hf = xe, ff = k, hf) {
  constructor(r, n) {
    super(r, n);
    N(this, "sqlName");
    N(this, "mapTo");
...
var mf, pf;
class Ia extends (pf = ot, mf = k, pf) {
  constructor(e, r, n) {
...
N(Ia, mf, "SQLiteBaseIntegerBuilder");
var yf, $f;
class ja extends ($f = xe, yf = k, $f) {
  constructor() {
    super(...arguments);
...
N(ja, yf, "SQLiteBaseInteger");
var gf, vf;
class Cy extends (vf = Ia, gf = k, vf) {
  constructor(e) {
...
N(Cy, gf, "SQLiteIntegerBuilder");
var _f, wf;
class Ay extends (wf = ja, _f = k, wf) {
}
N(Ay, _f, "SQLiteInteger");
var bf, Sf;
class ky extends (Sf = Ia, bf = k, Sf) {
  constructor(e, r) {
...
N(ky, bf, "SQLiteTimestampBuilder");
var Ef, Nf;
class Ly extends (Nf = ja, Ef = k, Nf) {
  constructor() {
    super(...arguments);
...
N(Ly, Ef, "SQLiteTimestamp");
var Pf, Tf;
class Dy extends (Tf = Ia, Pf = k, Tf) {
  constructor(e, r) {
...
N(Dy, Pf, "SQLiteBooleanBuilder");
var Of, Rf;
class My extends (Rf = ja, Of = k, Rf) {
  constructor() {
    super(...arguments);
    N(this, "mode", this.config.mode);
  }
...
N(My, Of, "SQLiteBoolean");
function Zc(t, e) {
  const { name: r, config: n } = ls(t, e);
  return (n == null ? void 0 : n.mode) === "timestamp" || (n == null ? void 0 : n.mode) === "timestamp_ms" ? new ky(r, n.mode) : (n == null ? void 0 : n.mode) === "boolean" ? new Dy(r, n.mode) : new Cy(r);
}
var If, jf;
class Vy extends (jf = ot, If = k, jf) {
  constructor(e) {
...
N(Vy, If, "SQLiteNumericBuilder");
var Cf, Af;
class Fy extends (Af = xe, Cf = k, Af) {
  mapFromDriverValue(e) {
...
N(Fy, Cf, "SQLiteNumeric");
var kf, Lf;
class qy extends (Lf = ot, kf = k, Lf) {
  constructor(e) {
...
N(qy, kf, "SQLiteNumericNumberBuilder");
var Df, Mf;
class zy extends (Mf = xe, Df = k, Mf) {
  constructor() {
    super(...arguments);
...
N(zy, Df, "SQLiteNumericNumber");
var Vf, Ff;
class Uy extends (Ff = ot, Vf = k, Ff) {
  constructor(e) {
...
N(Uy, Vf, "SQLiteNumericBigIntBuilder");
var qf, zf;
class By extends (zf = xe, qf = k, zf) {
  constructor() {
    super(...arguments);
...
N(By, qf, "SQLiteNumericBigInt");
function vj(t, e) {
  const { name: r, config: n } = ls(t, e), s = n == null ? void 0 : n.mode;
  return s === "number" ? new qy(r) : s === "bigint" ? new Uy(r) : new Vy(r);
}
var Uf, Bf;
class Ky extends (Bf = ot, Uf = k, Bf) {
  constructor(e) {
    super(e, "number", "SQLiteReal");
  }
  /** @internal */
  build(e) {
    return new Qy(e, this.config);
  }
}
N(Ky, Uf, "SQLiteRealBuilder");
var Kf, Qf;
class Qy extends (Qf = xe, Kf = k, Qf) {
  getSQLType() {
    return "real";
  }
}
...
var Gf, xf;
class Gy extends (xf = ot, Gf = k, xf) {
  constructor(e, r) {
...
N(Gy, Gf, "SQLiteTextBuilder");
var Hf, Jf;
class xy extends (Jf = xe, Hf = k, Jf) {
  constructor(r, n) {
    super(r, n);
...
N(xy, Hf, "SQLiteText");
var Wf, Xf;
class Hy extends (Xf = ot, Wf = k, Xf) {
  constructor(e) {
...
N(Hy, Wf, "SQLiteTextJsonBuilder");
var Yf, Zf;
class Jy extends (Zf = xe, Yf = k, Zf) {
  getSQLType() {
    return "text";
  }
  mapFromDriverValue(e) {
...
N(Jy, Yf, "SQLiteTextJson");
function ft(t, e = {}) {
  const { name: r, config: n } = ls(t, e);
  return n.mode === "json" ? new Hy(r) : new Gy(r, n);
}
function wj() {
  return {
    blob: $j,
...
var eh, th, rh, nh, sh;
class rt extends (sh = F, nh = k, rh = F.Symbol.Columns, th = Ao, eh = F.Symbol.ExtraConfigBuilder, sh) {
  constructor() {
    super(...arguments);
    /** @internal */
    N(this, rh);
...
N(rt, nh, "SQLiteTable"), /** @internal */
N(rt, "Symbol", Object.assign({}, F.Symbol, {
  InlineForeignKeys: Ao
}));
function bj(t, e, r, n, s = t) {
  const a = new rt(t, n, s), o = typeof e == "function" ? e(wj()) : e, i = Object.fromEntries(
...
class Xy {
  constructor(e) {
    ...
    N(this, "cachedTables", {});
    N(this, "convert");
    this.convert = e === "snake_case" ? Sj : e === "camelCase" ? Ej : Nj;
  }
  getColumnCasing(e) {
...
N(Xy, ih, "CasingCache");
var ch, lh;
class Ca extends (lh = Vr, ch = k, lh) {
}
N(Ca, ch, "SQLiteViewBase");
var uh;
uh = k;
class sa {
  constructor(e) {
    /** @internal */
    N(this, "casing");
    this.casing = new Xy(e == null ? void 0 : e.casing);
  }
  escapeName(e) {
    return `"${e.replace(/"/g, '""')}"`;
  }
  ...
  buildRelationalQuery({
    ...
    if (o === !0)
      ...
      if (o.where) {
        const D = typeof o.where == "function" ? o.where(m, lj()) : o.where;
        w = D && ra(D, i);
      }
      const b = [];
      let T = [];
      ...
      for (const { tsKey: D, value: Y } of b)
        l.push({
          ...
          tsKey: D,
          field: A(Y, Se) ? Pt(Y, i) : Y,
          relationTableTsKey: void 0,
          isJson: !1,
          selection: []
        });
      let q = typeof o.orderBy == "function" ? o.orderBy(m, uj()) : o.orderBy ?? [];
      ...
      for (const {
        ...
        const ge = mj(
          ...
          table: e[x],
          tableConfig: r[x],
          queryConfig: A(de, kr) ? Y === !0 ? { limit: 1 } : { ...Y, limit: 1 } : Y,
          tableAlias: ne,
          joinOn: G,
...
N(sa, uh, "SQLiteDialect");
var dh, fh;
class el extends (fh = sa, dh = k, fh) {
  migrate(e, r, n) {
...
class Rt {
  ...
  from(e) {
    ...
    ) : A(e, Ca) ? n = e[qe].selectedFields : A(e, W) ? n = {} : n = qI(e), new tl({
      table: e,
      fields: n,
      isPartialSelect: r,
...
N(Rt, mh, "SQLiteSelectBuilder");
var ph, yh;
class Zy extends (yh = Yy, ph = k, yh) {
  ...
  createSetOperator(r, n) {
    return (s) => {
      const a = typeof s == "function" ? s(Pj()) : s;
      if (!Xc(this.getSelectedFields(), a.getSelectedFields()))
        throw new Error(
...
N(Zy, ph, "SQLiteSelectQueryBuilder");
var $h, gh;
class tl extends (gh = Zy, $h = k, gh) {
  constructor() {
    super(...arguments);
    N(this, "run", (r) => this._prepare().run(r));
    N(this, "all", (r) => this._prepare().all(r));
...
function Aa(t, e) {
  return (r, n, ...s) => {
    ...
    for (const o of a)
      if (!Xc(r.getSelectedFields(), o.rightSelect.getSelectedFields()))
        throw new Error(
          "Set operator error (union / intersect / except): selected fields are not the same or are in a different order"
        );
...
}), Tj = Aa("union", !1), Oj = Aa("union", !0), Rj = Aa("intersect", !1), Ij = Aa("except", !1);
var vh;
vh = k;
class rl {
  constructor(e) {
  ...
  getDialect() {
    return this.dialect || (this.dialect = new el(this.dialectConfig)), this.dialect;
  }
}
N(rl, vh, "SQLiteQueryBuilder");
var _h;
_h = k;
class Lo {
  constructor(e, r, n, s) {
  ...
  select(e) {
    const r = typeof e == "function" ? e(new rl()) : e;
    if (!A(r, W) && !Xc(this.table[Oo], r._.selectedFields))
      throw new Error(
...
N(Lo, _h, "SQLiteInsertBuilder");
var wh, bh;
class Do extends (bh = tr, wh = k, bh) {
  ...
  onConflictDoUpdate(r) {
    ...
    const n = r.where ? R` where ${r.where}` : void 0, s = r.targetWhere ? R` where ${r.targetWhere}` : void 0, a = r.setWhere ? R` where ${r.setWhere}` : void 0, o = Array.isArray(r.target) ? R`${r.target}` : R`${[r.target]}`, i = this.dialect.buildUpdateSet(this.config.table, $y(this.config.table, r.set));
...
N(Mo, Sh, "SQLiteUpdateBuilder");
var Eh, Nh;
class e$ extends (Nh = tr, Eh = k, Nh) {
...
N(e$, Eh, "SQLiteUpdate");
var Ph, Th, Oh;
const xn = class xn extends (Oh = W, Th = k, Ph = Symbol.toStringTag, Oh) {
  constructor(r) {
    super(xn.buildEmbeddedCount(r.source, r.filters).queryChunks);
    N(this, "sql");
    N(this, Ph, "SQLiteCountBuilderAsync");
    N(this, "session");
...
N(xn, Th, "SQLiteCountBuilderAsync");
let Vo = xn;
var Rh;
Rh = k;
class t$ {
...
N(t$, Rh, "SQLiteAsyncRelationalQueryBuilder");
var Ih, jh;
class aa extends (jh = tr, Ih = k, jh) {
...
N(aa, Ih, "SQLiteAsyncRelationalQuery");
var Ch, Ah;
class Fo extends (Ah = aa, Ch = k, Ah) {
  sync() {
    return this.executeRaw();
  }
}
N(Fo, Ch, "SQLiteSyncRelationalQuery");
var kh, Lh;
class Ln extends (Lh = tr, kh = k, Lh) {
  constructor(r, n, s, a, o) {
    super();
    /** @internal */
    N(this, "config");
...
class nl {
  constructor(e, r, n, s) {
    ...
    N(this, "$with", (e, r) => {
      const n = this;
      return { as: (a) => (typeof a == "function" && (a = a(new rl(n.dialect))), new Proxy(
        new Wc(
          a.getSQL(),
          r ?? ("getSelectedFields" in a ? a.getSelectedFields() ?? {} : {}),
          e,
...
class s$ {
  ...
  async queryWithCache(e, r, n) {
    if (this.cache === void 0 || A(this.cache, sl) || this.queryMetadata === void 0)
      try {
        return await n();
      } catch (s) {
        throw new Gt(e, r, s);
    ...
    if (this.queryMetadata.type === "select") {
      const s = await this.cache.get(
        this.cacheConfig.tag ?? await xu(e, r),
  ...
  execute(e) {
    return this.mode === "async" ? this[this.executeMethod](e) : new n$(() => this[this.executeMethod](e));
  }
  mapResult(e, r) {
...
N(a$, Bh, "SQLiteSession");
var Kh, Qh;
class o$ extends (Qh = nl, Kh = k, Qh) {
...
N(o$, Kh, "SQLiteTransaction");
var Gh, xh;
class i$ extends (xh = a$, Gh = k, xh) {
  constructor(r, n, s, a = {}) {
    super(n);
    N(this, "logger");
    N(this, "cache");
    this.client = r, this.schema = s, this.logger = a.logger ?? new yy(), this.cache = a.cache ?? new sl();
  }
...
N(i$, Gh, "BetterSQLiteSession");
var Hh, Jh;
const la = class la extends (Jh = o$, Hh = k, Jh) {
  transaction(e) {
...
N(la, Hh, "BetterSQLiteTransaction");
let qo = la;
var Wh, Xh;
class c$ extends (Xh = s$, Wh = k, Xh) {
...
N(c$, Wh, "BetterSQLitePreparedQuery");
var Yh, Zh;
class l$ extends (Zh = nl, Yh = k, Zh) {
}
N(l$, Yh, "BetterSQLite3Database");
function Hr(t, e = {}) {
  const r = new el({ casing: e.casing });
  let n;
  e.logger === !0 ? n = new py() : e.logger !== !1 && (n = e.logger);
  let s;
  if (e.schema) {
    const i = dj(
      e.schema,
  ...
  const a = new i$(t, r, s, { logger: n }), o = new l$("sync", r, a, s);
  return o.$client = t, o;
}
function zo(...t) {
...
function fn() {
  return Fr().select().from(Lr).orderBy(Lr.title).all().map(al);
}
function u$(t) {
...
function Aj(t) {
  ...
  let n = 0;
  for (const s of t ?? [])
    s != null && s.title && (r.has(e(s.title, s.author || "")) || (u$({
      title: s.title,
      author: s.author || "",
...
function il() {
  return Fr().select().from(Yn).orderBy(Yn.title).all().map(ol);
}
function kj(t) {
...
let It = null, Zn = cl, Dn = null;
const es = /* @__PURE__ */ new Set();
async function Mj(t, e, r) {
...
function Vj(t, e, r) {
  ...
  Z.readFile(s, (a, o) => {
    ...
    r.setHeader("Content-Type", Dj[X.extname(s)] ?? "application/octet-stream"), r.end(o);
  });
}
function Fj() {
...
function zj(t) {
  It || (Dn = t.onCommand, Zn = cl, It = Ho.createServer((e, r) => {
...
`), es.add(r), e.on("close", () => es.delete(r));
    ...
    if (e.method === "GET" && e.url) {
      t.devServerUrl ? Mj(t.devServerUrl, e.url, r) : Vj(t.distDir, e.url, r);
      return;
    }
    r.writeHead(404), r.end();
  }), It.on("error", () => {
...
function h$() {
  ...
  es.clear(), It == null || It.close(), It = null, Dn = null, Zn = cl;
}
const sn = 3847, m$ = 3848, Uo = "seedscreen", Bo = /* @__PURE__ */ new Map();
...
function Ko() {
  ...
  try {
    We.send(t, 0, t.length, m$, "255.255.255.255");
  } catch {
  }
}
function Uj(t) {
  if (Xt || (Xt = Ho.createServer((e, r) => {
    ...
    const e = p$();
    We = N$.createSocket({ type: "udp4", reuseAddr: !0 }), We.on("error", () => {
    }), We.on("message", (r, n) => {
      if (n.address !== e)
        try {
...
function Bj() {
  return { ip: p$(), hostname: Dr.hostname(), port: sn, songCount: fn().length };
}
function y$() {
...
function $$() {
  const t = rm.showOpenDialogSync({
    properties: ["openFile"],
    filters: [{ name: "Images", extensions: ["png", "jpg", "jpeg", "gif", "webp", "svg"] }]
  }), e = t == null ? void 0 : t[0];
  if (!e) return null;
  const r = X.extname(e).toLowerCase(), n = xj[r] ?? "application/octet-stream", s = Z.readFileSync(e).toString("base64");
  return {
    name: X.basename(e, r),
    dataUrl: `data:${n};base64,${s}`
  };
}
const Ju = ["mp4", "webm", "mov", "m4v"], Hj = ["png", "jpg", "jpeg", "gif", "webp"], Jj = {
  ".png": "image/png",
  ".jpg": "image/jpeg",
  ".jpeg": "image/jpeg",
  ".gif": "image/gif",
...
tm.registerSchemesAsPrivileged([
  {
    scheme: "media",
...
function Xj() {
  const t = rm.showOpenDialogSync({
    ...
    filters: [{ name: "Media", extensions: [...Hj, ...Ju] }]
  });
  for (const e of t ?? []) {
    const r = X.extname(e).toLowerCase().slice(1), n = Ju.includes(r) ? "video" : "image", s = X.join(Qo(), `${Go()}.${r}`);
    Z.copyFileSync(e, s), kj({ type: n, title: X.basename(e, X.extname(e)), filePath: s });
  }
}
let js = null;
function ll() {
  if (js) return js;
  const t = X.join(process.resourcesPath, "bible.json"), e = X.join(ka, "../resources/bible.json"), r = Z.existsSync(t) ? t : e;
...
const ka = X.dirname(b$(import.meta.url));
process.env.APP_ROOT = X.join(ka, "..");
const hn = process.env.VITE_DEV_SERVER_URL, _C = X.join(process.env.APP_ROOT, "dist-electron"), La = X.join(process.env.APP_ROOT, "dist");
...
function v$() {
  ...
  }), hn ? ee.loadURL(hn) : ee.loadFile(X.join(La, "index.html"));
}
let Ee = null;
function Yj(t) {
  ...
  }), hn ? Ee.loadURL(`${hn}#output`) : Ee.loadFile(X.join(La, "index.html"), { hash: "output" }), Ee.on("closed", () => {
...
const Zj = process.platform === "darwin", eC = [
      ...
      { type: "separator" },
      {
        ...
        click: (t) => {
          t.checked ? (zj({
            ...
            active: !0,
            url: f$()
          })) : (h$(), ee == null || ee.webContents.send("remote:status-changed", { active: !1, url: null }));
        }
      }
    ]
  }
...
fe.handle("sync:get-local-info", () => Bj());
fe.handle("sync:get-peers", () => y$());
fe.handle("sync:search-peers", async () => (Kj(), await new Promise((t) => setTimeout(t, 2500)), y$()));
fe.handle("sync:fetch-songs", (t, e, r) => Qj(e, r));
fe.handle("sync:import-songs", (t, e) => Aj(e));
fe.handle("remote:get-status", () => ({
  active: Hu(),
  url: Hu() ? f$() : null
}));
fe.handle("remote:push-state", (t, e) => (qj(e), !0));
fe.handle("output:toggle", (t, e) => Ee ? (Ee.close(), { opened: !1 }) : (Yj(e), { opened: !0 }));
...
fe.handle("songs:add", (t, e) => u$(e));
fe.handle("songs:update", (t, e, r) => jj(e, r));
fe.handle("songs:delete", (t, e) => Cj(e));
function ul(t) {
  return t.map((e) => ({ ...e, url: Wj(e.filePath) }));
}
fe.handle("media:get-all", () => ul(il()));
fe.handle("media:add", () => (Xj(), ul(il())));
fe.handle("media:delete", (t, e) => {
  const r = Lj(e);
  return r && Z.rm(r.filePath, { force: !0 }, () => {
  }), ul(il());
});
fe.handle("bible:get-books", () => ll().books.map((t, e) => ({
  id: t.book_usfm,
  name: t.name,
  abbr: g$[t.book_usfm] ?? t.book_usfm,
  chapterCount: t.chapters.filter((r) => r.is_chapter !== !1).length,
  index: e
})));
fe.handle("bible:get-chapter", (t, e, r) => {
  const n = ll().books.find((o) => o.book_usfm === e);
  if (!n) return [];
...
fe.handle("bible:search", (t, e) => {
  ...
  for (const s of ll().books) {
    const a = g$[s.book_usfm] ?? s.book_usfm, o = s.chapters.filter((i) => i.is_chapter !== !1);
...
Lt.on("activate", () => {
  xo.getAllWindows().length === 0 && v$();
});
Lt.whenReady().then(() => {
  tm.handle("media", async (e) => {
    const r = new URL(e.url), n = decodeURIComponent(r.pathname.replace(/^\/+/, "")), s = X.join(Qo(), n);
    if (!s.startsWith(Qo()))
      return new Response("Forbidden", { status: 403 });
    try {
      const a = await Z.promises.readFile(s);
      return new Response(a, {
        headers: { "Content-Type": Jj[X.extname(s).toLowerCase()] ?? "application/octet-stream" }
      });
    } catch {
      return console.error(`[media] file not found: ${s}`), new Response("Not found", { status: 404 });
    }
  }), v$();
  const t = hl.buildFromTemplate(eC);
  hl.setApplicationMenu(t), an.on("display-added", () => ee == null ? void 0 : ee.webContents.send("displays-changed")), an.on("display-removed", () => ee == null ? void 0 : ee.webContents.send("displays-changed")), Uj((e) => ee == null ? void 0 : ee.webContents.send("sync-peer-found", e));
});
Lt.on("before-quit", () => {
  Gj(), h$();
});
