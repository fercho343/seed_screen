...
electron.contextBridge.exposeInMainWorld("electronAPI", {
  ...
  bibleGetBooks: (lang) => electron.ipcRenderer.invoke("bible:get-books", lang),
  bibleGetChapter: (bookId, chapterNum, lang) => electron.ipcRenderer.invoke("bible:get-chapter", bookId, chapterNum, lang),
  bibleSearch: (query, lang) => electron.ipcRenderer.invoke("bible:search", query, lang),
